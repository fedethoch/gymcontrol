...
const USER_TABS: TabItem[] = [
  ...
  { href: "/dashboard/rutinas", label: "Rutina", icon: Calendar },
      ...
      <div className="grid grid-cols-5">
        ...
        <Sheet open={moreOpen} onOpenChange={setMoreOpen}>
          <SheetTrigger asChild>
            <button
              type="button"
              className="flex flex-col items-center justify-center gap-1 py-2 text-[11px] font-semibold text-[#8a93ad] transition-colors hover:text-white"
            >
