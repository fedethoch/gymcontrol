...
export default async function CatalogRoutineDetailPage({
  ...
  return (
    <section className="page-frame detalle-frame relative isolate content-start bg-[var(--background)] lg:bg-[linear-gradient(180deg,#070a12_0%,#090d16_48%,#05070b_100%)]">
      ...
      {/* Mobile (<1024): portada, balance y días, DESIGN.md §19. */}
      <div className="flex flex-col lg:hidden">
        <div aria-hidden="true" className="home-safe-top" />
        <RoutineDetailMobile view={buildRoutineDetailView(routine)} context={actionContext} />
      </div>

      {/* Desktop: layout de siempre. */}
      <div className="hidden lg:contents">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                variant="ghost"
                size="icon"
                className="sm:hidden -ml-1 size-6 text-[var(--accent-bright)] hover:text-white"
              >
        ...
        <div className="-mt-3 grid gap-3 xl:grid-cols-[1.02fr_0.98fr]">
          <div className="relative min-h-[8rem] overflow-hidden rounded-2xl border border-[rgba(148,163,184,0.22)] bg-[#080b13] shadow-[0_22px_70px_rgba(0,0,0,0.42)] sm:min-h-[23rem] xl:min-h-[23.5rem]">
            {coverImageUrl ? (
              <>
                <Image
                  ...
                  src={coverImageUrl}
                />
                <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,7,17,0.42),rgba(8,7,17,0.18)),linear-gradient(180deg,transparent_40%,rgba(5,7,11,0.78)_100%)]" />
              </>
            ) : (
            ...
            <div className="absolute bottom-0 left-0 right-0 xl:hidden bg-gradient-to-t from-black/80 via-black/50 to-transparent px-4 pb-4 pt-12">
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-white/15 bg-[rgba(5,7,11,0.7)] px-2.5 py-1 text-xs font-semibold text-white backdrop-blur-sm">
            ...
            <div className="hidden xl:block absolute bottom-5 left-5 right-5 max-w-sm rounded-xl border border-[rgba(148,163,184,0.13)] bg-[#101726]/88 p-3.5 shadow-[0_18px_48px_rgba(0,0,0,0.42)] backdrop-blur">
              <div className="flex items-center gap-4">
                <div className="grid size-12 place-items-center rounded-xl bg-[rgba(16,185,129,0.12)] text-[var(--accent-bright)]">
          ...
          <aside className="hidden xl:flex flex-col rounded-2xl border border-[var(--border-strong)] bg-[linear-gradient(135deg,rgba(12,16,28,0.98),rgba(9,13,23,0.92))] p-5 shadow-[0_22px_70px_rgba(0,0,0,0.34)] sm:p-6 xl:min-h-[23.5rem]">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--accent-bright)]">
              DETALLE DE RUTINA
            </p>
...
function StatPill({ icon: Icon, label }: StatPillProps) {
  return (
    <span className="inline-flex items-center gap-3 rounded-xl border border-[var(--border-strong)] bg-[var(--card)] px-4 py-2 text-sm font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
