...
| `20260922_push_drop_test` | aplicada 2026-09-22, despues del deploy que saca `/api/push/test` (`3bc9ebe`) | contract: borra `push_subscriptions.last_test_at` |
