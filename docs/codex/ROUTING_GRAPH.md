...
| Admin | `app/admin/page.tsx`, `app/admin/ejercicios/page.tsx`, `app/admin/rutinas/page.tsx` | `app/lib/supabase/` | `profiles`, `exercises`, `routine_templates`, `routine_days`, `routine_items` |
