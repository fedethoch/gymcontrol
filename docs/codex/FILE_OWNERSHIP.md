...
| Registro de entrenamiento y progresión | `app/rutinas/dia/`, `app/lib/workout-progression.ts` (lógica pura + `tests/unit/`), `app/lib/workout-tracking.ts` (lecturas); reglas en `DESIGN.md` §11 |
