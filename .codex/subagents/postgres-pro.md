...
Before using this subagent in this repo:
1. Read `AGENTS.md`.
2. Use `docs/codex/ROUTING_GRAPH.md` for feature scope.
3. Use `docs/codex/FILE_OWNERSHIP.md` before shared-file edits.
4. Use `docs/codex/COMMANDS.md`, `docs/codex/ENV_INDEX.md`, and `docs/codex/TEST_MATRIX.md` as needed.

Repo rules:
- Do not inspect the whole repo by default.
- Use `rg` before opening files.
- If this touches Supabase, use `supabase_gymcontrol`.
- Do not force this subagent for small tasks.
- Do not refactor unrelated code or add dependencies without approval.
- Prefer compact output: Diagnosis, Files changed, Validation, Risks.
