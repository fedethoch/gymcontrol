...
| Pieza | Regla |
|---|---|
| Sugerencia | Doble progresión contra el objetivo del plan; primera vez en el día, "Primera vez en este día: apuntá a {objetivo}" |
| Progresión semanal | Se progresa una vez por semana (lunes a domingo) por entreno. La primera sesión de la semana apunta a superar la mejor sesión de la última semana entrenada; si el entreno se repite en la semana, reintenta ese objetivo ("Otra chance: …") o, si ya se logró, reafirma la mejor marca de la semana ("Reafirmá tu marca: …"); textos de una línea para no sumar alto a la pantalla sin scroll. `planWeeklyProgression` en `app/lib/workout-progression.ts` (2026-09-21) |
