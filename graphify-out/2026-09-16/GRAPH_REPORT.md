...
Cohesion: 0.07
Nodes (40): DiaryActions, serverDiaryActions, calculateStreak(), withCurrentDay(), deleteMeal(), deleteMealItem(), MealLog, updateMeal() (+32 more)
...
Cohesion: 0.11
Nodes (35): addMealItems(), buildItemValues(), createMealWithItems(), emptyMealLog(), ensureMealLogId(), findMealLogId(), FoodRow, getMealInLog() (+27 more)
...
Cohesion: 0.06
Nodes (53): DayPickerSheet(), WEEKDAY_NAMES, firstParam(), parseRegistroFoodParams(), addDaysToDateKey(), APP_TIME_ZONE, DATE_KEY_FORMATTER, getMondayFirstWeekdayIndex() (+45 more)
...
Cohesion: 0.17
Nodes (25): AddResult, STALE_MESSAGES, useDiaryActions(), addItem(), apply(), changeMealType(), deleteMeal(), enqueue() (+17 more)
