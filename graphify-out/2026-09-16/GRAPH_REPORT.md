...
## Corpus Check
- 682 files · ~1,655,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5966 nodes · 10022 edges · 474 communities (432 shown, 42 thin omitted)
...
### Community 9 - "ProfileSetupFlow.tsx"
Cohesion: 0.14
...
Cohesion: 0.06
Nodes (37): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, AdminRecipe, RecipeAdminClientProps, DIFFICULTY_BADGE_STYLES, OBJECTIVE_BADGE_STYLES (+29 more)
...
Cohesion: 0.06
Nodes (54): TodayExercisesSheet(), formatDayTitle(), HEIGHT_BY_STATE, HeroDay, TodayHero(), ChooseRoutineMobile(), EmptyRoutineMobile(), RoutineSwitcher() (+46 more)
...
Cohesion: 0.10
Nodes (39): activateRoutineFromCatalogAction(), revalidateRoutineSelection(), saveRoutineFromCatalogAction(), deleteAccountAction(), saveProfileNameAction(), DashboardLayout(), requireUser(), activateIfRequested() (+31 more)
...
Cohesion: 0.11
Nodes (26): DIFFICULTY_BADGE_VARIANT, quickActions, RecentExercisesTable(), fadeRow, RoutineDetailClientProps, RoutineTablePreviewProps, RoutineTableRow, WeekDay (+18 more)
...
Cohesion: 0.10
Nodes (33): ExerciseSheetTab, DayExercise, Drafts, WorkoutHandlers, DayState, describeSuggestion(), DraftSet, ExerciseDraft (+25 more)

### Community 22 - "registro/page.tsx"
Cohesion: 0.12
Nodes (25): AdminFoodsPage(), AlimentosPage(), readFrequentItems(), getOptionalAuthContext, AdminFoodListItem, createAnonClient(), FoodInput, FoodRow (+17 more)

### Community 23 - "app/alimentos/actions.ts"
Cohesion: 0.13
Nodes (23): deleteFoodAction(), saveFoodAction(), SaveFoodResult, FoodAdminClient(), confirmDelete(), FoodFormSheet(), handleSubmit(), AdminLayout() (+15 more)
...
Cohesion: 0.08
Nodes (54): CatalogEmpty(), CatalogNoResults(), CatalogMobileView(), changeDays(), changeLevel(), changeObjective(), clearFilters(), markInteracted() (+46 more)
...
Cohesion: 0.10
Nodes (31): saveRoutineAction(), INITIAL_ROUTINE_FORM_STATE, RoutineDayWriteInput, RoutineFormDayPayload, RoutineFormField, RoutineFormItemPayload, RoutineFormPayload, RoutineFormState (+23 more)

### Community 29 - "ExerciseAdminClient.tsx"
Cohesion: 0.05
Nodes (59): deleteExerciseAction(), saveExerciseAction(), ExerciseAdminClient(), confirmDelete(), ExerciseAdminClientProps, ExerciseFormSheet(), clearObjectUrl(), handleFileChange() (+51 more)

### Community 30 - "RecipeForm.tsx"
Cohesion: 0.06
Nodes (54): AdminRecetasPage(), RecipeAdminClient(), confirmDelete(), handleDelete(), DraftIngredient, formatOneDecimal(), RecipeForm(), handleSubmit() (+46 more)

### Community 31 - "auth-otp.ts"
Cohesion: 0.05
Nodes (61): isSupabaseRateLimitError(), json(), POST(), json(), POST(), OtpLoginFlow(), LoginPage(), LoginPageProps (+53 more)

### Community 32 - "RoutineCatalogClient.tsx"
Cohesion: 0.14
Nodes (19): CatalogoPage(), getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages(), RoutineCatalogCard(), RoutineCatalogClient(), handleClearFilters(), handleFilterChange() (+11 more)

### Community 33 - "renameSavedRoutineAction"
Cohesion: 0.24
Nodes (6): renameSavedRoutineAction(), confirmRename(), fadeUp(), RutinasOverview(), confirmEdit(), RutinasOverviewProps
...
Cohesion: 0.15
Nodes (19): MACRO_SHORT_LABELS, ManualCheck(), PlanRows(), PlanSheet, Row, Goal, GOAL_INFO, ACTIVITY_COPY (+11 more)
...
Cohesion: 0.06
Nodes (55): DiaryActions, serverDiaryActions, calculateStreak(), withCurrentDay(), deleteMeal(), deleteMealItem(), MealLog, updateMeal() (+47 more)
...
Cohesion: 0.11
Nodes (21): dayLabel(), formatDateLabel(), formatDateOnly(), NutritionCalendarCard(), WEEK_LABELS, PlaceholderPanelProps, dayLabel(), formatDateLabel() (+13 more)
...
Cohesion: 0.10
Nodes (33): buildRoutineDetailView(), catalogDaysHref(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient(), ActionContext, ActionControl() (+25 more)
...
Cohesion: 0.10
Nodes (30): DayClosedPanel(), DaySheet(), FrequentRows(), QuickRow, MealMenuSheet(), remove(), saveName(), withBusy() (+22 more)
...
Cohesion: 0.12
Nodes (33): addMealItems(), buildItemValues(), createMealWithItems(), emptyMealLog(), ensureMealLogId(), findMealLogId(), FoodRow, getMealInLog() (+25 more)

### Community 170 - "AddFoodSheet.tsx"
Cohesion: 0.07
Nodes (56): AddFoodSheet(), add(), amountFor(), choose(), markAdded(), Segment, Session, Step (+48 more)
...
### Community 186 - "addDaysToDateKey"
Cohesion: 0.13
Nodes (23): HomeWeekStrip(), DayPickerSheet(), WEEKDAY_NAMES, buildWeek(), DayCell, WeekCombinedCard(), WeekCombinedCardProps, addDaysToDateKey() (+15 more)
...
Cohesion: 0.14
Nodes (32): Comparison(), delta(), ExerciseHistoryData, ExerciseHistoryPanel(), Change(), ExerciseTrend(), PAD, bestSessionId() (+24 more)
...
Cohesion: 0.05
Nodes (67): Chip, FoodChips(), FoodCreateDrawer(), FoodCreateRequest, FoodDetailBody(), FoodDetailDrawer(), MACROS, View (+59 more)

### Community 258 - "RoutineWeekView.tsx"
Cohesion: 0.13
Nodes (15): DetailDay, DetailDays(), DetailExercise, subscribeNothing(), CompactDayAction(), DayAction(), DayPanel(), WeekDay (+7 more)
...
### Community 293 - "cn"
Cohesion: 0.08
Nodes (34): PlanHero(), HomeGreeting(), BodyFatFigure(), ArcGauge(), DropdownMenu(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel() (+26 more)

### Community 294 - "ExerciseDetailModal.tsx"
Cohesion: 0.14
Nodes (16): ExerciseDetailModalProps, FilterSheetProps, ADMIN_TABS, GUEST_TABS, MobileTabBarProps, TabItem, USER_TABS, NavigationPanel() (+8 more)
...
### Community 301 - "createSupabaseServerClient"
Cohesion: 0.14
...
### Community 315 - ".tmp-verify-detalle.mjs"
Cohesion: 0.26
Nodes (11): check(), env(), errors, fullShot(), login(), main(), overflow(), results (+3 more)
...
Cohesion: 0.05
Nodes (59): FoodSearchBar(), RecipeCreateDrawer(), RecipeCreateRequest, MACROS, RecipeDetailBody(), RecipeDetailDrawer(), View, RecipeList() (+51 more)

### Community 320 - "WorkoutMobile.tsx"
Cohesion: 0.08
Nodes (36): WeekStats(), ExerciseListRow, ExerciseListSheet(), ExerciseStage(), SetList(), SetRow, ActionButton(), FinishConfirm() (+28 more)
...
Cohesion: 0.20
Nodes (14): GET(), redirectToLogin(), ConfiguracionPage(), AppRole, AuthContext, getPostLoginRedirectPath(), loadAuthContext(), loadProfileRecord() (+6 more)
...
Cohesion: 0.05
Nodes (40): deleteOwnFoodAction(), FoodDetailSheet(), handleDelete(), FoodRow(), FormState, NutritionCatalogClient(), NutritionCatalogClientProps, OtpLoginFlowProps (+32 more)

### Community 396 - "useProfileForm.ts"
Cohesion: 0.14
Nodes (21): macroGramsSchema, manualTargetSchema, profileInputSchema, saveNutritionProfileAction(), ProfileSaveStatus, calculateBmr(), calculateMacros(), calculateNutritionPlan() (+13 more)
...
Cohesion: 0.11
Nodes (30): ProfileSheet(), SetupHero(), ExerciseSheet(), SheetExercise, BookmarkSubmit(), DeactivateSubmit(), ROUTINE_XXL_CLASS, countActiveFilters() (+22 more)

### Community 424 - "FoodList.tsx"
Cohesion: 0.18
Nodes (10): SelectFood, MACRO_KEYS, MacroRing(), Highlight(), RecipeRow(), SelectRecipe, splitMacroKcal(), MACRO_COLORS (+2 more)
...
Cohesion: 0.09
Nodes (26): deleteRoutineAction(), restoreRoutineAction(), revalidateRoutinePaths(), AdminRoutinesPage(), RoutineAdminClient(), confirmDelete(), handleRestore(), AdminRoutineListItem (+18 more)
...
### Community 430 - "Integrar acceso admin en el shell general: unificar la entrada administrativa sin duplicar la experiencia base"
Cohesion: 0.18
...
### Community 434 - "Integrar type_rol al flujo de acceso y sesion: distinguir admin de usuario normal"
Cohesion: 0.22
...
Cohesion: 0.24
Nodes (6): createEmptyDay(), createEmptyItem(), RoutineFormSheet(), handleAddDay(), handleAddItem(), handleSubmit()

### Community 439 - "meal-diary.ts"
Cohesion: 0.07
Nodes (43): STALE_MESSAGES, addItem(), AddTarget, BudgetState, buildDiaryDay(), capitalize(), DiaryDay, DiaryDeepLink (+35 more)

### Community 440 - "ConfiguracionClient"
Cohesion: 0.38
Nodes (6): ConfiguracionClient(), handleDeleteAccount(), handleSaveName(), useProfileForm(), handleGenderChange(), handleTargetModeChange()
...
### Community 447 - "GoalSheet.tsx"
Cohesion: 0.11
Nodes (17): ActivityMeter(), BAR_HEIGHTS, ACTIVITY_OPTIONS, ActivityOptions(), ActivitySheet(), GoalSheet(), ManualField(), ManualTargetFields() (+9 more)
...
Cohesion: 0.26
Nodes (8): CatalogFeatureCard(), CatalogRoutineList(), RoutineCover(), RoutineCoverImage(), TONES, buttonVariants, ROUTINE_DIFFICULTY_LABELS, ROUTINE_OBJECTIVE_LABELS

### Community 461 - "ExerciseMedia.tsx"
Cohesion: 0.60
Nodes (3): ExerciseMedia(), MediaView, useMediaQuery()
...
Cohesion: 0.08
Nodes (32): AccountRows(), HomeSectionHeader(), HomeWeekStats(), CALLOUTS, MuscleAnatomy(), changeView(), MuscleStrengthPoint, Side (+24 more)
...
## Knowledge Gaps
- **3150 isolated node(s):** `supabase_gymcontrol`, `results`, `errors`, `RecentActivityEntry`, `ACTIVITY_ICONS` (+3145 more)
...
- **What is the exact relationship between `Next.js Logo` and `Vercel Triangle Logo`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `cn()` connect `cn` to `food-catalog.ts`, `RoutineWeekView.tsx`, `ProfileSetupFlow.tsx`, `ConfiguracionClient.tsx`, `NutritionCatalogClient.tsx`, `app/page.tsx`, `admin/page.tsx`, `DayWorkoutClient.tsx`, `routine-catalog.ts`, `ExerciseAdminClient.tsx`, `RecipeForm.tsx`, `auth-otp.ts`, `profile-plan.ts`, `ExerciseDetailModal.tsx`, `Button.tsx`, `FoodList.tsx`, `DayCountWheel.tsx`, `AddFoodSheet.tsx`, `workout-progression.ts`, `RegistroClient.tsx`, `Card.tsx`, `ConfiguracionClient`, `addDaysToDateKey`, `NumberStepper.tsx`, `recipe-catalog.ts`, `GoalSheet.tsx`, `WorkoutMobile.tsx`, `CatalogFeatureCard.tsx`, `exercise-history.ts`, `[id]/page.tsx`, `MuscleAnatomy.tsx`, `RegistroMobile.tsx`, `PrimaryNavigation.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `createSupabaseServerClient()` connect `createSupabaseServerClient` to `RoutineCatalogClient.tsx`, `getSupabasePublicEnv`, `meal-logs.ts`, `useProfileForm.ts`, `RegistroClient.tsx`, `routines.ts`, `saved-routines.ts`, `app/page.tsx`, `workout-sync.ts`, `registro/page.tsx`, `app/alimentos/actions.ts`, `[id]/page.tsx`, `auth.ts`, `routine-validation.ts`, `ExerciseAdminClient.tsx`, `RecipeForm.tsx`, `auth-otp.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `RegistroClient()` connect `RegistroClient.tsx` to `cn`, `AddFoodSheet.tsx`, `ExerciseMedia.tsx`, `registro/page.tsx`, `meal-diary.ts`, `addDaysToDateKey`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `supabase_gymcontrol`, `results`, `errors` to the rest of the system?**
