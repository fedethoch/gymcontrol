...
## Corpus Check
- 556 files · ~3,972,194 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5075 nodes · 7299 edges · 425 communities (384 shown, 41 thin omitted)
...
## Communities (425 total, 41 thin omitted)
...
### Community 5 - "workout-progression.ts"
Cohesion: 0.18
Nodes (19): getSavedRoutineByIdForUser(), computeWeeklyStreak(), estimateDayMinutes(), estimateE1rm(), findBestSet(), getLoadStep(), isValidSet(), parseRestSeconds() (+11 more)
...
Cohesion: 0.13
Nodes (22): RecipeAdminClient(), confirmDelete(), handleSubmit(), archiveRecipe(), INITIAL_RECIPE_FORM_STATE, ParsedRecipePayload, RecipeFormField, RecipeFormPayload (+14 more)
...
Cohesion: 0.11
Nodes (30): activateRoutineFromCatalogAction(), revalidateRoutineSelection(), saveRoutineFromCatalogAction(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient(), activateIfRequested() (+22 more)
...
Cohesion: 0.09
Nodes (36): DIFFICULTY_BADGE_VARIANT, quickActions, RecentExercisesTable(), fadeRow, RoutineDetailClientProps, RoutineTablePreviewProps, RoutineTableRow, getMotivationalMessage() (+28 more)
...
Cohesion: 0.07
Nodes (38): deleteMeal(), deleteMealItem(), MealLog, updateMeal(), addItemSchema, addMealItemAction(), createMealAction(), createMealSchema (+30 more)
...
### Community 25 - "ExerciseHistorySheet.tsx"
Cohesion: 0.29
Nodes (10): ExerciseKind, ExerciseHistorySheet(), formatDate(), formatMetric(), HistoryContent(), HistoryExercise, maxOf(), metricLabel() (+2 more)
...
Cohesion: 0.07
Nodes (34): ACTIVITY_ICONS, formatActivityDate(), RecentActivityEntry, RecentActivityTable(), startOfDay(), getVisiblePages(), RoutineCatalogClient(), handleClearFilters() (+26 more)

### Community 30 - "NutritionCatalogClient.tsx"
Cohesion: 0.13
Nodes (19): FormState, NutritionCatalogClientProps, MacroBar(), normalizeSearchText(), scoreName(), searchByName(), CATEGORY_ACCENT, CATEGORY_GRADIENTS (+11 more)

### Community 31 - "createSupabaseServerClient"
Cohesion: 0.09
Nodes (36): AdminPage(), isSupabaseRateLimitError(), json(), POST(), json(), POST(), GET(), redirectToLogin() (+28 more)

### Community 32 - "auth.ts"
Cohesion: 0.08
Nodes (29): AdminRecetasPage(), NutritionCatalogClient(), NutricionPage(), errorCopy, LoginPage(), LoginPageProps, statusCopy, StatusToast() (+21 more)
...
### Community 37 - "RoutineAdminClient.tsx"
Cohesion: 0.05
Nodes (51): AdminRecipe, RecipeAdminClientProps, DIFFICULTY_BADGE_STYLES, OBJECTIVE_BADGE_STYLES, OBJECTIVE_DOT_STYLES, RoutineAdminClientProps, RoutineFormSheetProps, SortColumn (+43 more)
...
Cohesion: 0.05
Nodes (41): BusyState, OtpLoginFlowProps, requestErrorCopy, verifyErrorCopy, getRoutineCoverImage(), getRoutineItemCount(), RoutineCatalogCard(), RoutineCatalogClientProps (+33 more)
...
Cohesion: 0.05
Nodes (71): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, FoodRow(), FoodForm(), handleSubmit(), FoodFormProps (+63 more)
...
Cohesion: 0.11
Nodes (20): LoggedSet, CountedSessionRow, ExerciseHistoryEntry, HistoryRow, isCountedSession(), isPrincipalStrengthExercise(), ItemRow, listMuscleStrengthSummaries() (+12 more)
...
Cohesion: 0.09
Nodes (28): DayPanel(), WeekDay, WeekExercise, WeekStats(), DayTabs(), ChooseRoutineMobile(), EmptyRoutineMobile(), RoutineSwitcher() (+20 more)
...
Cohesion: 0.12
Nodes (29): formatKg(), formatLoggedSet(), formatSeconds(), parsePlanTarget(), findQueuedSessionForDay(), nextRev(), buildInitialState(), buildPlaceholder() (+21 more)
...
Cohesion: 0.08
Nodes (32): HomeSectionHeader(), HomeWeekStats(), CALLOUTS, MuscleAnatomy(), changeView(), MuscleStrengthPoint, Side, strongestGroup() (+24 more)

### Community 346 - "workout-sync-queue.ts"
Cohesion: 0.13
Nodes (30): WorkoutSyncRunner(), enqueueFinish(), enqueueItem(), eventListeners, firstError(), flushNow(), flushQueue(), flushUnlocked() (+22 more)
...
### Community 380 - "ejercicios/actions.ts"
Cohesion: 0.14
Nodes (20): deleteExerciseAction(), saveExerciseAction(), confirmDelete(), ExerciseFormSheet(), clearObjectUrl(), handleFileChange(), handleSubmit(), AdminLayout() (+12 more)
...
Cohesion: 0.15
Nodes (26): ConfiguracionPage(), getSessionProgress(), addDaysToDateKey(), APP_TIME_ZONE, DATE_KEY_FORMATTER, getMondayFirstWeekdayIndex(), getTodayDateKey(), getWeekStartDateKey() (+18 more)

### Community 397 - "ExerciseAdminClient.tsx"
Cohesion: 0.11
Nodes (20): ExerciseAdminClientProps, ExerciseFormSheetProps, SortColumn, SortDirection, UploadStatus, ExerciseDetailModal(), ExerciseDetailModalProps, FilterGroup (+12 more)
...
### Community 423 - "cn"
Cohesion: 0.08
Nodes (36): HomeGreeting(), SheetExercise, TodayExercisesSheet(), RoutineCover(), ROUTINE_XXL_CLASS, StartDock(), Button(), ButtonProps (+28 more)

### Community 425 - "Implementar autenticacion base de usuario: habilitar Supabase Auth server-side para el MVP"
Cohesion: 0.09
Nodes (21): Contexto de auth con rol expuesto a layout, navegacion y guards, Archivos, Criterios de aceptacion, Estado, Estado final, Implementar autenticacion base de usuario: habilitar Supabase Auth server-side para el MVP, Objetivo, Pasos (+13 more)
...
Cohesion: 0.08
Nodes (31): ExerciseAdminClient(), AdminExercisesPage(), AdminRoutinesPage(), createAnonClient(), CreateExerciseInput, ExerciseCatalogItem, ExerciseRow, formatExerciseDate() (+23 more)
...
Cohesion: 0.26
Nodes (8): buildMealRows(), buildDayMealRows(), DayMealRow, DEFAULT_DAY_MEAL_TYPES, insertAfter(), moveInOrder(), rankOf(), suggestAfterMealId()
...
## Knowledge Gaps
- **2954 isolated node(s):** `supabase_gymcontrol`, `RecentActivityEntry`, `ACTIVITY_ICONS`, `FoodAdminClientProps`, `SortColumn` (+2949 more)
...
- **What is the exact relationship between `Next.js Logo` and `Vercel Triangle Logo`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `createSupabaseServerClient()` connect `createSupabaseServerClient` to `auth.ts`, `requireUser`, `RoutineAdminClient.tsx`, `workout-progression.ts`, `routines.ts`, `meal-logs.ts`, `registro/page.tsx`, `recipes.ts`, `recetas/actions.ts`, `saved-routines.ts`, `workout-tracking.ts`, `catalogo/page.tsx`, `registro/actions.ts`, `foods.ts`, `RoutineFormSheet`, `routine-validation.ts`, `ejercicios/actions.ts`, `workout-sync.ts`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `app/rutinas/page.tsx`, `MuscleAnatomy.tsx`, `RoutineAdminClient.tsx`, `DayWorkoutClient.tsx`, `week.ts`, `RegistroClient.tsx`, `ExerciseAdminClient.tsx`, `PrimaryNavigation.tsx`, `admin/page.tsx`, `registro/actions.ts`, `app/page.tsx`, `ExerciseHistorySheet.tsx`, `workout-sync-queue.ts`, `ejercicios/actions.ts`, `NutritionCatalogClient.tsx`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `MyRoutinesList()` connect `cn` to `requireUser`, `app/rutinas/page.tsx`?**
