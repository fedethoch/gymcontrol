...
## Corpus Check
- 472 files · ~723,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4472 nodes · 6173 edges · 401 communities (365 shown, 36 thin omitted)
...
Cohesion: 0.13
Nodes (15): app/globals.css, docs/architecture/07-frontend-experience.md, Direccion visual general del producto (premium minimalista), Fronteras funcionales entre modulos (Agregar rutinas, Mis rutinas, Ejercicio, Admin), Mapa de vistas y transiciones del MVP, Comportamiento del modal de ejercicio, Navegacion base usuario/admin en panel lateral, Pantalla Agregar rutinas (catalogo) (+7 more)
...
Cohesion: 0.12
Nodes (16): Acuerdo de minima manipulacion, Campos que se mantienen fuera por ahora, Database, Decisiones de simplicidad aprobadas, Entidades que no entran por ahora, Estado de implementacion real en Supabase, Fuente de verdad, Objetivo (+8 more)
...
Cohesion: 0.07
Nodes (33): ExerciseAdminClientProps, ExerciseFormSheet(), ExerciseFormSheetProps, SortColumn, SortDirection, UploadStatus, equipmentLabel(), MUSCLE_BADGE_STYLES (+25 more)

### Community 30 - "RootLayout"
Cohesion: 0.10
Nodes (35): ConfiguracionClient(), ConfiguracionPage(), deleteSavedRoutineAction(), renameSavedRoutineAction(), toggleActiveSavedRoutineAction(), DashboardLayout(), activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction() (+27 more)
...
Cohesion: 0.08
Nodes (29): RootLayout(), CatalogRoutineDetailPage(), getOptionalAuthContext, Macros, errorCopy, LoginPage(), LoginPageProps, reasonCopy (+21 more)

### Community 35 - "deleteSavedRoutineAction"
Cohesion: 0.05
Nodes (39): dependencies, class-variance-authority, clsx, framer-motion, lucide-react, next, radix-ui, @radix-ui/react-dialog (+31 more)
...
Cohesion: 0.11
Nodes (35): autosaveWorkoutSessionItemAction(), parseSeriesValues(), parseWorkoutItem(), revalidateWorkoutPaths(), DayWorkoutClient(), DayPageProps, DayRoutinePage(), addDays() (+27 more)
...
### Community 105 - "cn"
Cohesion: 0.08
Nodes (30): RowSaveIndicator(), SummaryMetric(), WorkoutStatusToggle(), FoodMeasure, cn(), calculateStreak(), DraftItem, formatDateOnly() (+22 more)
...
Cohesion: 0.13
Nodes (26): DIFFICULTY_BADGE_VARIANT, quickActions, ACTIVITY_ICONS, formatActivityDate(), RecentActivityEntry, RecentActivityTable(), startOfDay(), RecentExercisesTable() (+18 more)
...
Cohesion: 0.13
Nodes (20): deleteAccountAction(), saveNutritionProfileAction(), saveProfileNameAction(), calculateBmr(), calculateMacros(), calculateNutritionPlan(), mapNutritionProfile(), NutritionProfile (+12 more)
...
Cohesion: 0.08
Nodes (45): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, NutritionCatalogClientProps, getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages() (+37 more)
...
Cohesion: 0.12
Nodes (19): CatalogoPage(), AdminRoutineListItem, createRoutine(), CreateRoutineInput, ExerciseRow, getRoutineById(), insertRoutineChildren(), listRoutineTemplates() (+11 more)
...
Cohesion: 0.11
Nodes (26): deleteExerciseAction(), saveExerciseAction(), EXERCISE_IMAGE_ALLOWED_EXTENSIONS, EXERCISE_IMAGE_ALLOWED_MIME_TYPES, EQUIPMENT_LABELS, EXERCISE_EQUIPMENT_OPTIONS, EXERCISE_MUSCLE_GROUPS, ExerciseEquipment (+18 more)
...
Cohesion: 0.12
Nodes (30): Home(), addDays(), addMealLogItem(), createMeal(), deleteMeal(), deleteMealLogItem(), ensureMealLogId(), FoodRow (+22 more)
...
Cohesion: 0.08
Nodes (34): bodyFont, displayFont, metadata, monoFont, ADMIN_TABS, GUEST_TABS, MobileTabBar(), MobileTabBarProps (+26 more)
...
Cohesion: 0.09
Nodes (23): DashboardRoutinesClient(), DashboardRoutinesClientProps, DashboardPage(), DashboardPageProps, reasonCopy, CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient() (+15 more)

### Community 388 - "Community 388"
Cohesion: 0.21
Nodes (11): ExerciseAdminClient(), AdminExercisesPage(), AdminExerciseListItem, CreateExerciseInput, ExerciseCatalogItem, ExerciseRow, formatExerciseDate(), getExerciseById() (+3 more)
...
Cohesion: 0.11
Nodes (19): DayWorkoutClientProps, DayWorkoutRow, DraftState, RowSaveState, SeriesInputsGroup(), splitSeriesValues(), getSavedRoutineByIdForUser(), DashboardRoutinesPage() (+11 more)
...
Cohesion: 0.36
Nodes (7): AdminLayout(), requireAdmin(), hasStructureErrors(), parseRoutinePayload(), deleteRoutine(), deleteRoutineAction(), saveRoutineAction()
...
## Knowledge Gaps
- **2776 isolated node(s):** `supabase_gymcontrol`, `RecentActivityEntry`, `ACTIVITY_ICONS`, `FoodAdminClientProps`, `SortColumn` (+2771 more)
