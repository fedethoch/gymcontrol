# Graph Report - gymcontrol  (2026-07-02)

## Corpus Check
- 486 files · ~3,792,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4626 nodes · 6472 edges · 422 communities (372 shown, 50 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `564aec58`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Project Foundations & Tech Stack|Project Foundations & Tech Stack]]
- [[_COMMUNITY_MVP Feature Specs Modal, QA, Dashboard|MVP Feature Specs: Modal, QA, Dashboard]]
- [[_COMMUNITY_Architecture Modules, Flows & Layers|Architecture Modules, Flows & Layers]]
- [[_COMMUNITY_Frontend Experience & Auth Roles|Frontend Experience & Auth Roles]]
- [[_COMMUNITY_Auth Dual Transition (OTP + Google)|Auth Dual Transition (OTP + Google)]]
- [[_COMMUNITY_Next.js Best Practices Reference|Next.js Best Practices Reference]]
- [[_COMMUNITY_Architecture & Codex Routing Docs|Architecture & Codex Routing Docs]]
- [[_COMMUNITY_RLS Policies & Auth Implementation|RLS Policies & Auth Implementation]]
- [[_COMMUNITY_Security, A11y & Auth Skills|Security, A11y & Auth Skills]]
- [[_COMMUNITY_Database Schema Definition (G2)|Database Schema Definition (G2)]]
- [[_COMMUNITY_Admin Exercises & Routines CRUD|Admin Exercises & Routines CRUD]]
- [[_COMMUNITY_Graphify Skill Documentation|Graphify Skill Documentation]]
- [[_COMMUNITY_Postgres Indexing & Locking References|Postgres Indexing & Locking References]]
- [[_COMMUNITY_GymControl Plan & README Overview|GymControl Plan & README Overview]]
- [[_COMMUNITY_Frontend Experience Flow Specs|Frontend Experience Flow Specs]]
- [[_COMMUNITY_Postgres Performance & Security Refs|Postgres Performance & Security Refs]]
- [[_COMMUNITY_Auth Transition Validation & Root Docs|Auth Transition Validation & Root Docs]]
- [[_COMMUNITY_Next.js Cache Components & Suspense|Next.js Cache Components & Suspense]]
- [[_COMMUNITY_Codex Router & Testing Skills|Codex Router & Testing Skills]]
- [[_COMMUNITY_HomeDashboardNavbar UI Screenshots|Home/Dashboard/Navbar UI Screenshots]]
- [[_COMMUNITY_G12 MVP Closure & Backlog|G12 MVP Closure & Backlog]]
- [[_COMMUNITY_Catalogo Page Screenshots & Route|Catalogo Page Screenshots & Route]]
- [[_COMMUNITY_Reference Design Screenshots|Reference Design Screenshots]]
- [[_COMMUNITY_Bug Screenshots Routines ListDetail|Bug Screenshots: Routines List/Detail]]
- [[_COMMUNITY_Default Next.js Icons (FileGlobeWindow)|Default Next.js Icons (File/Globe/Window)]]
- [[_COMMUNITY_Implementation Strategy Actions & Validation|Implementation Strategy: Actions & Validation]]
- [[_COMMUNITY_Bug Screenshots Active Week Widget|Bug Screenshots: Active Week Widget]]
- [[_COMMUNITY_Frontend Design Skill & License|Frontend Design Skill & License]]
- [[_COMMUNITY_Default Next.js Icons (VercelNext)|Default Next.js Icons (Vercel/Next)]]
- [[_COMMUNITY_Community 29|Community 29]]
- [[_COMMUNITY_RootLayout|RootLayout]]
- [[_COMMUNITY_Profile image upload preview shows blank white box and old files not cleaned on replace|Profile image upload preview shows blank white box and old files not cleaned on replace]]
- [[_COMMUNITY_GET|GET]]
- [[_COMMUNITY_CatalogoPage|CatalogoPage]]
- [[_COMMUNITY_Codex G11 Upload Placeholder Image|Codex G11 Upload Placeholder Image]]
- [[_COMMUNITY_deleteSavedRoutineAction|deleteSavedRoutineAction]]
- [[_COMMUNITY_renameSavedRoutineAction|renameSavedRoutineAction]]
- [[_COMMUNITY_setActiveSavedRoutineAction|setActiveSavedRoutineAction]]
- [[_COMMUNITY_DashboardLayout|DashboardLayout]]
- [[_COMMUNITY_autosaveWorkoutSessionItemAction|autosaveWorkoutSessionItemAction]]
- [[_COMMUNITY_saveWorkoutSessionAction|saveWorkoutSessionAction]]
- [[_COMMUNITY_DayRoutinePage|DayRoutinePage]]
- [[_COMMUNITY_saveExerciseAction|saveExerciseAction]]
- [[_COMMUNITY_AdminExercisesPage|AdminExercisesPage]]
- [[_COMMUNITY_activateRoutineFromCatalogAction|activateRoutineFromCatalogAction]]
- [[_COMMUNITY_saveRoutineFromCatalogAction|saveRoutineFromCatalogAction]]
- [[_COMMUNITY_AppRole|AppRole]]
- [[_COMMUNITY_AuthContext|AuthContext]]
- [[_COMMUNITY_getPostLoginRedirectPath|getPostLoginRedirectPath]]
- [[_COMMUNITY_isValidEmail|isValidEmail]]
- [[_COMMUNITY_isValidOtpToken|isValidOtpToken]]
- [[_COMMUNITY_normalizeEmail|normalizeEmail]]
- [[_COMMUNITY_normalizeOtpToken|normalizeOtpToken]]
- [[_COMMUNITY_requireAdmin|requireAdmin]]
- [[_COMMUNITY_requireUser|requireUser]]
- [[_COMMUNITY_resolveAuthContextForUserId|resolveAuthContextForUserId]]
- [[_COMMUNITY_resolvePostLoginRedirectForUserId|resolvePostLoginRedirectForUserId]]
- [[_COMMUNITY_ExerciseFormField|ExerciseFormField]]
- [[_COMMUNITY_ExerciseFormPayload|ExerciseFormPayload]]
- [[_COMMUNITY_ExerciseFormState|ExerciseFormState]]
- [[_COMMUNITY_parseExercisePayload|parseExercisePayload]]
- [[_COMMUNITY_validateExerciseImageFile|validateExerciseImageFile]]
- [[_COMMUNITY_AdminExerciseListItem|AdminExerciseListItem]]
- [[_COMMUNITY_createExercise|createExercise]]
- [[_COMMUNITY_ExerciseCatalogItem|ExerciseCatalogItem]]
- [[_COMMUNITY_getExerciseById|getExerciseById]]
- [[_COMMUNITY_listAdminExercises|listAdminExercises]]
- [[_COMMUNITY_listExerciseCatalogItems|listExerciseCatalogItems]]
- [[_COMMUNITY_updateExercise|updateExercise]]
- [[_COMMUNITY_consumeOtpRequestRateLimit|consumeOtpRequestRateLimit]]
- [[_COMMUNITY_getRequestIp|getRequestIp]]
- [[_COMMUNITY_getRequestOrigin|getRequestOrigin]]
- [[_COMMUNITY_RoutineDayWriteInput|RoutineDayWriteInput]]
- [[_COMMUNITY_RoutineFormDayPayload|RoutineFormDayPayload]]
- [[_COMMUNITY_RoutineFormField|RoutineFormField]]
- [[_COMMUNITY_RoutineFormItemPayload|RoutineFormItemPayload]]
- [[_COMMUNITY_RoutineFormPayload|RoutineFormPayload]]
- [[_COMMUNITY_RoutineFormState|RoutineFormState]]
- [[_COMMUNITY_RoutineItemFormField|RoutineItemFormField]]
- [[_COMMUNITY_RoutineItemWriteInput|RoutineItemWriteInput]]
- [[_COMMUNITY_RoutineStructureErrors|RoutineStructureErrors]]
- [[_COMMUNITY_RoutineWriteInput|RoutineWriteInput]]
- [[_COMMUNITY_RoutineDifficulty|RoutineDifficulty]]
- [[_COMMUNITY_RoutineObjective|RoutineObjective]]
- [[_COMMUNITY_parseRoutinePayload|parseRoutinePayload]]
- [[_COMMUNITY_AdminRoutineListItem|AdminRoutineListItem]]
- [[_COMMUNITY_createRoutine|createRoutine]]
- [[_COMMUNITY_getRoutineById|getRoutineById]]
- [[_COMMUNITY_listAdminRoutines|listAdminRoutines]]
- [[_COMMUNITY_listRoutineTemplates|listRoutineTemplates]]
- [[_COMMUNITY_RoutineDay|RoutineDay]]
- [[_COMMUNITY_RoutineExerciseRef|RoutineExerciseRef]]
- [[_COMMUNITY_RoutineItem|RoutineItem]]
- [[_COMMUNITY_RoutineTemplate|RoutineTemplate]]
- [[_COMMUNITY_updateRoutine|updateRoutine]]
- [[_COMMUNITY_deleteSavedRoutineForUser|deleteSavedRoutineForUser]]
- [[_COMMUNITY_getSavedRoutineByIdForUser|getSavedRoutineByIdForUser]]
- [[_COMMUNITY_getSavedRoutineByTemplateForUser|getSavedRoutineByTemplateForUser]]
- [[_COMMUNITY_listSavedRoutinesForUser|listSavedRoutinesForUser]]
- [[_COMMUNITY_renameSavedRoutineForUser|renameSavedRoutineForUser]]
- [[_COMMUNITY_SavedRoutineDetail|SavedRoutineDetail]]
- [[_COMMUNITY_SavedRoutineListItem|SavedRoutineListItem]]
- [[_COMMUNITY_saveRoutineForUser|saveRoutineForUser]]
- [[_COMMUNITY_setSavedRoutineActiveForUser|setSavedRoutineActiveForUser]]
- [[_COMMUNITY_toggleSavedRoutineActiveForUser|toggleSavedRoutineActiveForUser]]
- [[_COMMUNITY_cn|cn]]
- [[_COMMUNITY_getCurrentWeekRange|getCurrentWeekRange]]
- [[_COMMUNITY_getLocalTrainingDate|getLocalTrainingDate]]
- [[_COMMUNITY_getWorkoutSessionForDate|getWorkoutSessionForDate]]
- [[_COMMUNITY_getWorkoutSessionForToday|getWorkoutSessionForToday]]
- [[_COMMUNITY_listWorkoutWeeklySummaries|listWorkoutWeeklySummaries]]
- [[_COMMUNITY_saveWorkoutSession|saveWorkoutSession]]
- [[_COMMUNITY_saveWorkoutSessionForToday|saveWorkoutSessionForToday]]
- [[_COMMUNITY_WorkoutSession|WorkoutSession]]
- [[_COMMUNITY_WorkoutSessionItem|WorkoutSessionItem]]
- [[_COMMUNITY_WorkoutSessionItemInput|WorkoutSessionItemInput]]
- [[_COMMUNITY_WorkoutSessionStatus|WorkoutSessionStatus]]
- [[_COMMUNITY_WorkoutWeeklySummary|WorkoutWeeklySummary]]
- [[_COMMUNITY_LoginPage|LoginPage]]
- [[_COMMUNITY_proxy|proxy]]
- [[_COMMUNITY_pg_stat_statements Extension|pg_stat_statements Extension]]
- [[_COMMUNITY_POST|POST]]
- [[_COMMUNITY_saveRoutineAction|saveRoutineAction]]
- [[_COMMUNITY_AdminRoutinesPage|AdminRoutinesPage]]
- [[_COMMUNITY_ExerciseDetail|ExerciseDetail]]
- [[_COMMUNITY_NavigationGroup|NavigationGroup]]
- [[_COMMUNITY_resolveShellRouteMeta|resolveShellRouteMeta]]
- [[_COMMUNITY_ShellRouteMeta|ShellRouteMeta]]
- [[_COMMUNITY_PlaceholderPanel|PlaceholderPanel]]
- [[_COMMUNITY_RouteCard|RouteCard]]
- [[_COMMUNITY_POST|POST]]
- [[_COMMUNITY_POST|POST]]
- [[_COMMUNITY_context-manager subagent|context-manager subagent]]
- [[_COMMUNITY_deployment-engineer subagent|deployment-engineer subagent]]
- [[_COMMUNITY_typescript-pro subagent|typescript-pro subagent]]
- [[_COMMUNITY_createSupabaseBrowserClient|createSupabaseBrowserClient]]
- [[_COMMUNITY_getSupabasePublicEnv|getSupabasePublicEnv]]
- [[_COMMUNITY_SupabasePublicEnv|SupabasePublicEnv]]
- [[_COMMUNITY_updateSession|updateSession]]
- [[_COMMUNITY_createSupabaseServerClient|createSupabaseServerClient]]
- [[_COMMUNITY_AppShell|AppShell]]
- [[_COMMUNITY_SectionEyebrow|SectionEyebrow]]
- [[_COMMUNITY_SurfaceCard|SurfaceCard]]
- [[_COMMUNITY_POST|POST]]
...
1. `cn()` - 105 edges
2. `createSupabaseServerClient()` - 84 edges
...
- `Contexto de auth con rol expuesto a layout, navegacion y guards` --shares_data_with--> `app/layout.tsx`  [INFERRED]
  specs/G5-auth-and-roles/02-integrar-type-rol-al-flujo-de-acceso-y-sesion.md → app/layout.tsx
- `Catalogo Desktop Card Layout (Routine Cards Grid)` --conceptually_related_to--> `Catalogo Page Route (app/catalogo/page.tsx)`  [INFERRED]
  .codex-temp/catalogo-desktop-cards.png → app/catalogo/page.tsx
- `Catalogo Desktop Full Page (Sidebar + Filters + Routine Catalog Header)` --conceptually_related_to--> `Catalogo Page Route (app/catalogo/page.tsx)`  [INFERRED]
  .codex-temp/catalogo-desktop.png → app/catalogo/page.tsx
- `Catalogo Mobile Card Layout (Routine Card Stacked View)` --conceptually_related_to--> `Catalogo Page Route (app/catalogo/page.tsx)`  [INFERRED]
  .codex-temp/catalogo-mobile-cards.png → app/catalogo/page.tsx
- `Catalogo Mobile Full Page (Header + Filters + Routine List)` --conceptually_related_to--> `Catalogo Page Route (app/catalogo/page.tsx)`  [INFERRED]
  .codex-temp/catalogo-mobile.png → app/catalogo/page.tsx

## Import Cycles
- None detected.

## Hyperedges (group relationships)
- **Codex Project Overlay Shared by All .codex Skills** — skill_accessibility_skill, best_practices_skill_best_practices, better_auth_best_practices_skill, better_auth_emailandpassword_skill, core_web_vitals_skill, gymcontrol_agents_gymcontrol_agents_guide [EXTRACTED 0.95]
- **graphify Full Pipeline (Detect, Extract, Build, Cluster, Export, Update)** — graphify_skill_pipeline_steps, extraction_spec_subagent_prompt, update_graphify_update_incremental, exports_graphify_export_wiki, graphify_skill_query_path_explain [EXTRACTED 0.90]
...
- **Codex Project Overlay shared by frontend-design and next-best-practices skills** — frontend_design_skill_frontend_design, next_best_practices_skill_next_best_practices, next_best_practices_debug_tricks_debug_tricks [EXTRACTED 0.95]
- **Next.js data-fetching waterfall avoidance strategies** — next_best_practices_data_patterns_promise_all_pattern, next_best_practices_data_patterns_streaming_suspense, next_best_practices_data_patterns_preload_pattern [EXTRACTED 1.00]
- **Modal pattern via parallel + intercepting routes** — next_best_practices_parallel_routes_parallel_intercepting_routes, next_best_practices_parallel_routes_router_back_pattern, next_best_practices_parallel_routes_default_tsx_requirement [EXTRACTED 1.00]
- **Next.js Cache Lifecycle Management** — next_cache_components_use_cache_directive, next_cache_components_cachelife, next_cache_components_cachetag, next_cache_components_updatetag, next_cache_components_revalidatetag [EXTRACTED 0.90]
- **Postgres Connection Management Practices** — references_conn_pooling, references_conn_limits, references_conn_idle_timeout, references_conn_prepared_statements [INFERRED 0.85]
- **Postgres Concurrency and Locking Practices** — references_lock_advisory, references_lock_deadlock_prevention, references_lock_short_transactions, references_lock_skip_locked [INFERRED 0.85]
- **Index Optimization Strategy Group** — references_query_composite_indexes_composite_index, references_query_covering_indexes_covering_index, references_query_index_types_index_type_selection, references_query_partial_indexes_partial_index, references_query_missing_indexes_missing_index_detection [INFERRED 0.85]
- **RLS Security and Performance Pattern** — references_security_rls_basics_row_level_security, references_security_rls_performance_rls_performance_optimization, references_security_rls_performance_security_definer_function, references_security_privileges_least_privilege [INFERRED 0.85]
- **Codex Project Overlay Routing Files** — agents_md_router, docs_codex_routing_graph, docs_codex_file_ownership, docs_codex_commands, docs_codex_env_index, docs_codex_test_matrix [EXTRACTED 1.00]
- **Routine template/day/item data model used across architecture flows and DATABASE.md** — database_doc_routine_templates, database_doc_routine_days, database_doc_routine_items, flows_admin_crear_rutinas_semanales, modules_admin_dashboard [INFERRED 0.85]
- **Shared Project Overlay rules across all .codex/subagents/*.md files (AGENTS.md, ROUTING_GRAPH, FILE_OWNERSHIP)** — subagents_context_manager_context_manager, subagents_database_administrator_database_administrator, subagents_debugger_debugger, subagents_deployment_engineer_deployment_engineer, subagents_frontend_developer_frontend_developer, subagents_nextjs_developer_nextjs_developer, subagents_postgres_pro_postgres_pro, subagents_security_auditor_security_auditor, subagents_typescript_pro_typescript_pro, subagents_ui_designer_ui_designer, subagents_ui_ux_tester_ui_ux_tester [EXTRACTED 1.00]
- **Auth flow (OTP + Google OAuth) resolves to profiles.type_rol for both module access and RLS** — flows_acceso_vigente, modules_acceso_y_sesion, database_doc_profiles, database_doc_rls_policies_g55, database_doc_handle_new_user_trigger [EXTRACTED 1.00]
- **G1-architecture specs resolve into docs/architecture/*.md** — g1_architecture_01_delimitar_alcance_final_del_mvp, g1_architecture_02_definir_modulos_principales_del_producto, g1_architecture_03_definir_responsabilidades_y_fronteras, g1_architecture_04_documentar_flujo_admin_crear_ejercicios, g1_architecture_05_documentar_flujo_admin_crear_rutinas_semanales, g1_architecture_06_documentar_flujo_usuario_explorar_y_guardar_rutinas, g1_architecture_07_documentar_flujo_del_modal_de_ejercicio, g1_architecture_08_definir_estructura_de_carpetas_y_nombres, g1_architecture_09_definir_estrategia_de_componentes_vistas_y_acciones, architecture_01_scope, architecture_02_modules, architecture_03_flows, architecture_04_layers_and_boundaries, architecture_05_structure_and_naming_estructura_de_carpetas, architecture_06_implementation_strategy_estrategia_de_implementacion, architecture_07_frontend_experience_frontend_experience [EXTRACTED 1.00]
- **docs/codex/ tactical routing layer files form a navigation system** — codex_routing_graph_routing_graph, codex_file_ownership_file_ownership, codex_commands_commands, codex_env_index_env_index, codex_test_matrix_test_matrix, codex_skill_routing_skill_routing, codex_prompt_templates_prompt_templates, codex_maintenance_rules_maintenance_rules [EXTRACTED 1.00]
- **Shell, panel lateral and navegacion form the unified user/admin experience pattern** — architecture_07_frontend_experience_shell_principal, architecture_07_frontend_experience_panel_lateral_izquierdo, architecture_07_frontend_experience_navegacion_base, architecture_07_frontend_experience_usuario_admin_mismo_shell, architecture_07_frontend_experience_admin_dashboard_visual [EXTRACTED 1.00]
...
- **Convergence of OTP and Google identities into single profile/role model** — 05_definir_como_convergen_sesion_y_perfil_entre_otp_y_google_definir_como_convergen_sesion_y_perfil_entre_otp_y_google, concept_profiles_trigger, concept_profiles_type_rol, concept_auth_guards [INFERRED 0.85]
...
- **Estructura semanal de rutinas: routine_templates -> routine_days -> routine_items** — database_md_table_routine_templates, database_md_table_routine_days, database_md_table_routine_items, g2_database_04_definir_relacion_rutina_dias_y_filas [EXTRACTED 0.95]
...
- **Cadena de implementacion: DATABASE.md (G2) traducido a SQL concreto en G2.1** — docs_database, g2_1_01_traducir_database_md_a_reglas_sql_concretas, g2_1_03_crear_tabla_profiles, g2_1_04_crear_tabla_exercises [INFERRED 0.85]
- **Pipeline de migracion G2: constraints -> SQL final -> aplicar -> documentar** — g2_1_08_agregar_constraints_e_indices_minimos_finales, g2_1_09_generar_migracion_sql_final_de_g2, g2_1_10_aplicar_migracion_en_supabase_y_verificar_esquema_real, g2_1_11_sincronizar_documentacion_operativa_de_g2 [EXTRACTED 1.00]
- **Decision pipeline G3: identificar, filtrar, acotar y documentar skills/agentes** — g3_skills_and_agents_01_identificar_tareas_recurrentes_que_justifican_skills_o_agentes, g3_skills_and_agents_02_separar_necesidades_reales_de_ideas_prematuras, g3_skills_and_agents_03_decidir_que_puede_resolverse_sin_skill_dedicada, g3_skills_and_agents_04_definir_cantidad_minima_de_skills_necesarias, g3_skills_and_agents_05_definir_si_hace_falta_algun_agente_adicional, g3_skills_and_agents_08_guardar_definicion_en_skills_and_agents_md [EXTRACTED 1.00]
- **G4 MVP setup: stack, deps, limpieza, estructura, estilos, datos, layout, esqueleto** — g4_mvp_setup_01_confirmar_stack_final_y_dependencias_necesarias, g4_mvp_setup_02_instalar_y_configurar_librerias_imprescindibles, g4_mvp_setup_04_crear_estructura_de_carpetas_pactada, g4_mvp_setup_05_configurar_estilos_base_y_ui_compartida, g4_mvp_setup_06_configurar_acceso_a_base_de_datos_y_entorno, g4_mvp_setup_07_crear_layout_base_y_navegacion_inicial, g4_mvp_setup_08_dejar_esqueleto_navegable_de_las_vistas_principales [EXTRACTED 1.00]
- **G4.5 sequential decision chain consolidated into 07-frontend-experience.md** — frontend_experience_shell_principal, frontend_experience_navegacion_base, frontend_experience_mapa_vistas, frontend_experience_direccion_visual, architecture_07_frontend_experience_doc [EXTRACTED 1.00]
- **Shell + views implementation and validation cycle** — g4_5_frontend_base_and_experience_17_implementar_shell_navegable_definitivo_del_frontend_base, g4_5_frontend_base_and_experience_18_implementar_vistas_base_y_placeholders_del_nuevo_flujo, g4_5_frontend_base_and_experience_19_validar_navegacion_responsive_panel_y_modal_con_playwright, app_layout_tsx [EXTRACTED 1.00]
...
- **RLS admin helper strategy shared across profiles, catalog, and admin writes** — g5_5_rls_and_policies_private_is_current_user_admin, g5_5_rls_and_policies_04_aplicar_policies_para_profiles, g5_5_rls_and_policies_05_aplicar_policies_para_catalogo_base, g5_5_rls_and_policies_07_restringir_escrituras_administrativas_a_admin [EXTRACTED 0.90]
- **G6 exercise admin pipeline (model, validation, images, listing view)** — g6_admin_exercises_01_implementar_modelo_persistente_de_ejercicio, g6_admin_exercises_02_implementar_validaciones_de_alta_y_edicion, g6_admin_exercises_03_resolver_almacenamiento_o_referencia_de_imagenes, g6_admin_exercises_04_crear_vista_de_listado_de_ejercicios_en_admin_dashboard [EXTRACTED 0.90]
...
## Communities (422 total, 50 thin omitted)

### Community 0 - "Project Foundations & Tech Stack"
Cohesion: 0.13
Nodes (15): AGENTS.md, docs/codex/ (Codex routing layer), docs/PROJECT_FOUNDATIONS.md, docs/SKILLS_AND_AGENTS.md, docs/WORKING_AGREEMENTS.md, Archivos, Criterios de aceptacion, Estado (+7 more)

### Community 1 - "MVP Feature Specs: Modal, QA, Dashboard"
Cohesion: 0.08
Nodes (54): Admin Exercise Creation Flow, Admin Weekly Routine Builder Flow, Modal de detalle de ejercicio (patron reutilizable), Rutina guardada de usuario (recurso de cuenta), docs/architecture/, docs/ARCHITECTURE.md, docs/DATABASE.md, docs/PROJECT_FOUNDATIONS.md (+46 more)

### Community 2 - "Architecture Modules, Flows & Layers"
Cohesion: 0.23
Nodes (13): Architecture - MVP Scope, Architecture - Modules, Architecture - Flows, handle_new_user() trigger, profiles table, ARCHITECTURE.md (gateway), Flujo de acceso vigente (OTP + Google OAuth), Flujo modal de detalle de ejercicio (+5 more)
...
### Community 6 - "Architecture & Codex Routing Docs"
Cohesion: 0.16
Nodes (8): Architecture, Architecture README index, Orden recomendado de lectura, Regla, Architecture, Nota, Orden recomendado de lectura, G1-architecture group
...
Cohesion: 0.28
Nodes (3): Acuerdo de minima manipulacion de la base de datos, Tabla exercises, supabase/migrations/

### Community 10 - "Admin Exercises & Routines CRUD"
Cohesion: 0.38
Nodes (10): G7.08 Validar recuperacion de rutina con estructura completa, routine_days table, routine_templates table, G8.01 Crear vista catalogo de rutinas disponibles, G8.02 Mostrar informacion minima util de cada rutina, G8.03 Permitir entrar al detalle de una rutina, G8.04 Mostrar estructura semanal de la rutina elegida, G8.05 Hacer clickeables los ejercicios para su detalle (+2 more)

### Community 11 - "Graphify Skill Documentation"
Cohesion: 0.09
...
### Community 14 - "Frontend Experience Flow Specs"
Cohesion: 0.15
Nodes (14): Modal de ejercicio, Pantalla Detalle diario de rutina, Relacion entre tabla y modal, Tabla de rutina, Tabla de rutina y modal de ejercicio, Archivos, Criterios de aceptacion, Documentar flujo admin para crear rutinas semanales: describir dias, filas y estructura de trabajo (+6 more)

### Community 15 - "Postgres Performance & Security Refs"
Cohesion: 0.12
Nodes (18): EXPLAIN ANALYZE Diagnostics, Autovacuum Tuning, VACUUM and ANALYZE Maintenance, Composite Index, Covering Index (INCLUDE), Index Type Selection (B-tree/GIN/GiST/BRIN/Hash), Missing Index on WHERE/JOIN Columns, Partial Index (+10 more)

### Community 16 - "Auth Transition Validation & Root Docs"
Cohesion: 0.27
...
Cohesion: 0.36
Nodes (13): AGENTS.md Project Router, docs/codex/COMMANDS.md, docs/codex/ENV_INDEX.md, docs/codex/FILE_OWNERSHIP.md, docs/codex/ROUTING_GRAPH.md, docs/codex/TEST_MATRIX.md, Lighthouse v13 Performance Insight Audits, web-quality-audit Skill (+5 more)

### Community 19 - "Home/Dashboard/Navbar UI Screenshots"
Cohesion: 0.25
Nodes (8): app/page.tsx (Home Page Route), app/dashboard/page.tsx (Dashboard Route), app/dashboard/rutinas/page.tsx (Routines Detail Route), Home/Inicio Screen (Finished) - Active Week Dashboard, Sidebar Navigation (Finished) - GymControl Panel Operativo, PrimaryNavigation Component, Mis Rutinas Dashboard (To Do) - Routine Catalog with Stats, Semana Activa Detail (To Do) - Weekly Active Routine Schedule

### Community 20 - "G12 MVP Closure & Backlog"
Cohesion: 0.12
Nodes (17): Acuerdo de minima manipulacion, Campos que se mantienen fuera por ahora, Database, Decisiones de simplicidad aprobadas, Entidades que no entran por ahora, Estado de implementacion real en Supabase, Fuente de verdad, Objetivo (+9 more)

### Community 21 - "Catalogo Page Screenshots & Route"
Cohesion: 0.80
Nodes (5): Catalogo Page Route (app/catalogo/page.tsx), Catalogo Desktop Full Page (Sidebar + Filters + Routine Catalog Header), Catalogo Desktop Card Layout (Routine Cards Grid), Catalogo Mobile Full Page (Header + Filters + Routine List), Catalogo Mobile Card Layout (Routine Card Stacked View)

### Community 22 - "Reference Design Screenshots"
Cohesion: 0.67
Nodes (4): Routine Catalog Reference Design, Routine Detail Catalog Page Reference Design, Dashboard Daily Routine Workout Reference Design, GymApp UI Reference Sheet (Login, Dashboard, Routine Creation, Catalog, Programs)

### Community 23 - "Bug Screenshots: Routines List/Detail"
Cohesion: 0.67
Nodes (3): Catalog routine cards list view with active and editable test routines, QA routine card detail showing Marcar activa and Abrir actions, Mis rutinas dashboard showing saved routines stats and rename bug context

### Community 24 - "Default Next.js Icons (File/Globe/Window)"
Cohesion: 0.67
Nodes (3): File Icon, Globe Icon, Window Icon

### Community 25 - "Implementation Strategy: Actions & Validation"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (30): activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), RoutineDay, RoutineExerciseRef, activateFirstSavedRoutineForUser(), deleteSavedRoutineForUser(), ExerciseRow, formatDateLabel() (+22 more)

### Community 32 - "GET"
Cohesion: 0.18
Nodes (18): DIFFICULTY_BADGE_VARIANT, quickActions, ACTIVITY_ICONS, formatActivityDate(), RecentActivityEntry, RecentActivityTable(), startOfDay(), RecentExercisesTable() (+10 more)

### Community 33 - "CatalogoPage"
Cohesion: 0.07
Nodes (24): MealGroup, MEAL_TYPE_LABELS, dayLabel(), formatDateLabel(), formatDateOnly(), NutritionCalendarCard(), WEEK_LABELS, dayLabel() (+16 more)

### Community 35 - "deleteSavedRoutineAction"
Cohesion: 0.09
Nodes (22): dependencies, class-variance-authority, clsx, framer-motion, input-otp, lucide-react, next, radix-ui (+14 more)

### Community 36 - "renameSavedRoutineAction"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (45): autosaveWorkoutSessionItemAction(), parseSeriesValues(), parseWorkoutItem(), revalidateWorkoutPaths(), DayWorkoutClient(), DayPageProps, RutinaDiaPage(), addDays() (+37 more)
...
### Community 43 - "AdminExercisesPage"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (24): GET(), noStoreHeaders(), GET(), noStoreHeaders(), RouteContext, ALLOWED_RESOLUTIONS, buildExerciseDbImageUrl(), buildExerciseDbStaticImageUrl() (+16 more)

### Community 46 - "AppRole"
Cohesion: 0.11
Nodes (18): Comportamiento del modal de ejercicio, Mapa de vistas y transiciones, Pantalla `Agregar rutinas`, Pantalla `Detalle diario de rutina`, Pantalla `Ejercicio`, Pantalla `Mis rutinas`, Tipos de transicion, Vistas admin (+10 more)
...
Cohesion: 0.19
Nodes (18): emailSchema, isValidEmail(), isValidOtpToken(), normalizeEmail(), normalizeOtpToken(), otpTokenSchema, consumeOtpRequestRateLimit(), emailBuckets (+10 more)
...
Cohesion: 0.10
Nodes (18): File Ownership, Auditar feature, Bug desconocido con debugger, Context optimization, Debug deploy / env, Deploy o env, Diagnosticar bug, Patch minimo (+10 more)

### Community 53 - "requireAdmin"
Cohesion: 0.12
...
### Community 56 - "resolvePostLoginRedirectForUserId"
Cohesion: 0.09
Nodes (22): Archivos de componentes, Archivos de pagina o vista, Archivos de utilidad o logica, Carpetas, Convenciones de nombres, Estructura base recomendada, Estructura de carpetas, Regla de orden (+14 more)

### Community 57 - "ExerciseFormField"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (20): app/lib/supabase/ (clientes Supabase), .env.example, G5 (auth, proteccion de rutas), Archivos, Confirmar stack final y dependencias necesarias: cerrar la base tecnica del MVP, Criterios de aceptacion, Estado, Estado final (+12 more)

### Community 62 - "AdminExerciseListItem"
Cohesion: 0.25
...
### Community 64 - "ExerciseCatalogItem"
Cohesion: 0.12
Nodes (18): MCP Supabase Setup for GymControl, Decision actual, Fuente de verdad, Lo que hoy no justifica una skill propia del repo, Objetivo, Regla para auth y seguridad, Skills And Agents, Skills disponibles pero no elegidas por defecto (+10 more)

### Community 65 - "getExerciseById"
Cohesion: 0.15
...
### Community 66 - "listAdminExercises"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (49): CatalogoPage(), CatalogRoutineDetailPage(), listExerciseCatalogItems, INITIAL_ROUTINE_FORM_STATE, RoutineDayWriteInput, RoutineFormDayPayload, RoutineFormField, RoutineFormItemPayload (+41 more)

### Community 68 - "updateExercise"
Cohesion: 0.33
Nodes (13): exercise-images storage bucket (G6), exercises table, RLS policies G5.5, routine_days table, routine_items table, routine_templates table, saved_routines table, workout_session_items table (+5 more)

### Community 69 - "consumeOtpRequestRateLimit"
Cohesion: 0.15
...
Cohesion: 0.20
Nodes (9): Commands, Allowed changes, Codex context layer maintenance rules, Non-goals, Purpose, Required checks before editing, Size budget, Skill/subagent validation (+1 more)
...
Cohesion: 0.11
Nodes (24): AdminLayout(), deleteFoodAction(), saveFoodAction(), SaveFoodResult, FoodAdminClient(), AdminFoodsPage(), requireAdmin(), AdminFoodListItem (+16 more)
...
### Community 91 - "RoutineExerciseRef"
Cohesion: 0.20
...
### Community 95 - "deleteSavedRoutineForUser"
Cohesion: 0.20
...
### Community 96 - "getSavedRoutineByIdForUser"
Cohesion: 0.20
...
### Community 97 - "getSavedRoutineByTemplateForUser"
Cohesion: 0.20
...
### Community 98 - "listSavedRoutinesForUser"
Cohesion: 0.20
...
### Community 99 - "renameSavedRoutineForUser"
Cohesion: 0.20
...
### Community 100 - "SavedRoutineDetail"
Cohesion: 0.20
...
### Community 101 - "SavedRoutineListItem"
Cohesion: 0.20
...
### Community 102 - "saveRoutineForUser"
Cohesion: 0.20
...
### Community 103 - "setSavedRoutineActiveForUser"
Cohesion: 0.20
...
### Community 104 - "toggleSavedRoutineActiveForUser"
Cohesion: 0.20
...
### Community 105 - "cn"
Cohesion: 0.06
Nodes (51): fadeRow, RoutineDetailClientProps, MACRO_COLORS, MACRO_LABELS, cn(), BusyState, OtpLoginFlow(), OtpLoginFlowProps (+43 more)
...
### Community 107 - "getLocalTrainingDate"
Cohesion: 0.20
...
### Community 108 - "getWorkoutSessionForDate"
Cohesion: 0.20
...
### Community 109 - "getWorkoutSessionForToday"
Cohesion: 0.20
...
### Community 110 - "listWorkoutWeeklySummaries"
Cohesion: 0.20
...
### Community 111 - "saveWorkoutSession"
Cohesion: 0.20
...
### Community 112 - "saveWorkoutSessionForToday"
Cohesion: 0.20
...
### Community 114 - "WorkoutSessionItem"
Cohesion: 0.20
...
### Community 115 - "WorkoutSessionItemInput"
Cohesion: 0.20
...
### Community 116 - "WorkoutSessionStatus"
Cohesion: 0.20
...
### Community 117 - "WorkoutWeeklySummary"
Cohesion: 0.20
...
### Community 123 - "saveRoutineAction"
Cohesion: 0.20
...
### Community 124 - "AdminRoutinesPage"
Cohesion: 0.20
...
### Community 128 - "resolveShellRouteMeta"
Cohesion: 0.20
...
### Community 130 - "PlaceholderPanel"
Cohesion: 0.14
...
### Community 137 - "createSupabaseBrowserClient"
Cohesion: 0.20
...
### Community 138 - "getSupabasePublicEnv"
Cohesion: 0.20
...
### Community 139 - "SupabasePublicEnv"
Cohesion: 0.20
...
### Community 141 - "createSupabaseServerClient"
Cohesion: 0.20
...
Cohesion: 0.25
Nodes (8): Acceso a datos y entorno, Auth post-MVP, Env Index, NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY, NEXT_PUBLIC_SUPABASE_URL, Operativas / MCP, Runtime de la app, SUPABASE_ACCESS_TOKEN_GYMCONTROL
...
Cohesion: 0.10
Nodes (18): Archivos, Criterios de aceptacion, Delimitar alcance final del MVP: confirmar que entra en la primera version y que queda fuera, Estado, Estado final, Objetivo, Pasos, Resolucion (+10 more)
...
Cohesion: 0.12
Nodes (21): EXERCISE_IMAGE_ALLOWED_EXTENSIONS, EXERCISE_IMAGE_ALLOWED_MIME_TYPES, EQUIPMENT_LABELS, EXERCISE_EQUIPMENT_OPTIONS, EXERCISE_MUSCLE_GROUPS, ExerciseEquipment, ExerciseFormField, ExerciseFormPayload (+13 more)
...
Cohesion: 0.18
Nodes (10): Tabla profiles, Archivos, Criterios de aceptacion, Definir type_rol y su uso en permisos: representar el control minimo de acceso en datos, Estado, Estado final, Objetivo, Pasos (+2 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Criterios de aceptacion, Definir cantidad minima de skills necesarias: acotar el set util del proyecto, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Criterios de aceptacion, Estado, Estado final, Guardar definicion en SKILLS_AND_AGENTS.md: consolidar la decision final del grupo, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Criterios de aceptacion, Definir direccion visual general del producto: acordar la identidad frontend del MVP, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.12
Nodes (19): ExerciseAdminClientProps, ExerciseFormSheet(), ExerciseFormSheetProps, SortColumn, SortDirection, UploadStatus, equipmentLabel(), MUSCLE_BADGE_STYLES (+11 more)
...
Cohesion: 0.19
Nodes (14): AdminPage(), deleteAccountAction(), saveNutritionProfileAction(), saveProfileNameAction(), AdminStats, getAdminStats(), getManagementSummary(), getRecentActivity() (+6 more)
...
Cohesion: 0.16
Nodes (19): computeStreak(), countDatesInWindow(), dayMuscleGroups(), estimateDayMinutes(), Home(), ConfiguracionPage(), addDays(), formatDateOnly() (+11 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Crear estructura de carpetas pactada: materializar la organizacion tecnica definida, Criterios de aceptacion, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Configurar acceso a base de datos y entorno: preparar la conexion tecnica del proyecto, Criterios de aceptacion, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.22
Nodes (9): Archivos, Criterios de aceptacion, Definir redirecciones segun estado autenticado y rol: ordenar la navegacion de acceso, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.25
Nodes (8): ARIA Tabs Pattern, Live Regions / Notifications Pattern, Modal Focus Trap Code Pattern, Skip Link Pattern, Modal Focus Trap Pattern, Accessibility (a11y) Skill, WCAG POUR Principles, Focus Not Obscured 2.4.11
...
Cohesion: 0.13
Nodes (24): ConfiguracionClient(), GOAL_ADJ_LABELS, ProfileSaveStatus, ToggleOption(), MOCK_FOODS, MOCK_FOODS_BASE, MOCK_PROFILE_DEFAULTS, ACTIVITY_LEVEL_INFO (+16 more)
...
Cohesion: 0.29
Nodes (7): Convencion de avance, Grupos, Nota, Objetivo, Orden recomendado de ejecucion, Regla de uso, Specs
...
Cohesion: 0.08
Nodes (39): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, NutritionCatalogClientProps, getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages() (+31 more)
...
Cohesion: 0.33
Nodes (6): Next.js, Skills preferidas del proyecto, Supabase, Postgres y permisos, Testing de app local, Trabajo general del repo, UI y frontend

### Community 285 - "Community 285"
Cohesion: 0.17
Nodes (9): Dependencias operativas, G10 - Exercise Modal, Objetivo del grupo, Orden recomendado, Resultado esperado, G11 - Integration And QA, Objetivo del grupo, Orden recomendado (+1 more)

### Community 286 - "Community 286"
Cohesion: 0.33
Nodes (5): Estado del grupo, G1 - Architecture, Objetivo del grupo, Orden recomendado, Resultado esperado

### Community 287 - "Community 287"
Cohesion: 0.17
Nodes (16): getRequestOrigin(), delay(), DIRECT_SLUGS, EXERCISE_SEARCH_TERMS, extractGifUrl(), fetchHtml(), findExerciseUrl(), getRequiredEnv() (+8 more)
...
Cohesion: 0.13
Nodes (17): collectRoutineExercises(), DASHBOARD_ASSETS, DEFAULT_OUT, exerciseToAsset(), fetchExercises(), fetchFoods(), fetchRecipes(), fetchRoutines() (+9 more)
...
Cohesion: 0.40
Nodes (5): Decision inicial del grupo, G13 - Auth Transition, Objetivo del grupo, Orden recomendado, Resultado esperado
...
Cohesion: 0.23
Nodes (12): deleteExerciseAction(), saveExerciseAction(), createExercise(), CreateExerciseInput, deleteExercise(), ExerciseCatalogItem, ExerciseRow, formatExerciseDate() (+4 more)
...
Cohesion: 0.13
Nodes (13): countCompletedSeries(), DayWorkoutClientProps, DayWorkoutRow, DraftState, formatSeconds(), RestTimer, RestTimerCard(), RowSaveIndicator() (+5 more)
...
Cohesion: 0.13
Nodes (27): DashboardLayout(), requireUser(), addMealLogItem(), createMeal(), deleteMeal(), deleteMealLogItem(), ensureMealLogId(), FoodRow (+19 more)
...
Cohesion: 0.09
Nodes (24): bodyFont, displayFont, metadata, monoFont, RootLayout(), viewport, getOptionalAuthContext, LoginPage() (+16 more)
...
Cohesion: 0.29
Nodes (7): config, proxy(), createSupabaseBrowserClient(), getSupabasePublicEnv(), SupabasePublicEnv, supabasePublicEnvSchema, updateSession()
...
Cohesion: 0.05
Nodes (52): CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient(), ROUTINE_DIFFICULTIES, ROUTINE_DIFFICULTY_LABELS, ROUTINE_OBJECTIVE_LABELS, ROUTINE_OBJECTIVES, RoutineDifficulty (+44 more)
...
Cohesion: 0.39
Nodes (8): Modal de detalle de ejercicio, G6.05 Crear formulario para alta de ejercicio, G6.06 Crear edicion basica de ejercicio si aplica, G6.07 Exponer datos de ejercicio para consumo transversal, G6.08 Verificar persistencia y recuperacion correcta, exercises table, G7.09 Verificar consistencia de referencias a ejercicios, routine_items table

### Community 390 - "Community 390"
Cohesion: 0.09
Nodes (31): FilterSheet(), FilterSheetProps, ADMIN_TABS, GUEST_TABS, MobileTabBarProps, TabItem, USER_TABS, NavigationGroup (+23 more)
...
Cohesion: 0.64
Nodes (7): G7.01 Implementar persistencia de rutina plantilla, G7.02 Implementar persistencia de dias de rutina semanal, G7.03 Implementar persistencia de filas de ejercicio, G7.04 Crear listado de rutinas en admin dashboard, G7.05 Crear builder o formulario de rutina semanal, G7.06 Permitir agregar multiples dias a una rutina, G7.07 Permitir agregar multiples filas de ejercicios por dia
...
Cohesion: 0.14
Nodes (13): anteriorData, BodyMuscleFigure(), buildLibraryMuscleColors(), DEFAULT_MUSCLE_DATA, fillMuscleData(), HIGHLIGHTED_COLORS, IExerciseData, IMuscleData (+5 more)
...
Cohesion: 0.29
Nodes (7): Architecture - Layers and Boundaries, Capa: Componentes compartidos, Capa: Logica de aplicacion, Capa: Persistencia y acceso a datos, Capa: UI y vistas, Capa: Validacion, Modulo: Capa de datos
...
Cohesion: 0.40
Nodes (5): Dependencias, G6 - Admin Exercises, Objetivo del grupo, Orden recomendado, Resultado esperado
...
Cohesion: 0.08
Nodes (23): 0. Principios, 1.1 Superficies (se mantienen), 1.2 Texto, 1.3 Acento — Emerald (NUEVO, reemplaza violeta), 1.4 Semánticos de estado (hue distinto al brand), 1.5 Contraste (piso obligatorio), 1. Color, 2.1 Escala (mobile-first, `rem`) (+15 more)
...
Cohesion: 0.17
Nodes (12): devDependencies, eslint, eslint-config-next, playwright, sharp, tailwindcss, @tailwindcss/postcss, @types/node (+4 more)

### Community 414 - "Community 414"
Cohesion: 0.17
Nodes (12): scripts, build, check, check:ui, dev, exercisedb:audit, lint, media:manifest (+4 more)
...
Cohesion: 0.33
Nodes (5): Ciclo AUDITAR ⇄ EJECUTAR — 2 prompts, Cierre de sección, Prompt A — AUDITAR, Prompt B — EJECUTAR, Secciones
...
Cohesion: 0.67
Nodes (3): ExerciseAdminClient(), AdminExercisesPage(), listAdminExercises()
...
- `Target Size 2.5.8 (24x24px)` → `INP (Interaction to Next Paint)`  [AMBIGUOUS]
  .codex/skills/core-web-vitals/SKILL.md · relation: semantically_similar_to
...
- `Sidebar Navigation (Finished) - GymControl Panel Operativo` → `Mis Rutinas Dashboard (To Do) - Routine Catalog with Stats`  [AMBIGUOUS]
  public/references/to_do/dashboard.png · relation: conceptually_related_to

## Knowledge Gaps
- **2818 isolated node(s):** `supabase_gymcontrol`, `RecentActivityEntry`, `ACTIVITY_ICONS`, `FoodAdminClientProps`, `SortColumn` (+2813 more)
...
- **What is the exact relationship between `Target Size 2.5.8 (24x24px)` and `INP (Interaction to Next Paint)`?**
...
- **What is the exact relationship between `Sidebar Navigation (Finished) - GymControl Panel Operativo` and `Mis Rutinas Dashboard (To Do) - Routine Catalog with Stats`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Plan - indice y orden de ejecucion` connect `Community 288` to `Community 320`, `Community 257`, `Community 289`, `Community 258`, `Community 322`, `Community 323`, `Community 300`, `Community 301`, `Community 302`, `Community 278`, `Community 315`, `Community 316`, `Community 317`, `Community 318`, `Community 319`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Database` connect `G12 MVP Closure & Backlog` to `Community 386`, `Database Schema Definition (G2)`, `Community 361`, `Community 372`, `Community 375`, `Community 377`, `Community 379`?**
