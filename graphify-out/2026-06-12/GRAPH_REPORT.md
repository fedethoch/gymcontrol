# Graph Report - gymcontrol  (2026-06-12)

## Corpus Check
- 398 files · ~612,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3820 nodes · 4840 edges · 365 communities (329 shown, 36 thin omitted)
...
1. `cn()` - 63 edges
2. `createSupabaseServerClient()` - 48 edges
3. `PLAN.md` - 24 edges
...
## Communities (365 total, 36 thin omitted)
...
Cohesion: 0.11
Nodes (24): AdminLayout(), deleteExerciseAction(), saveExerciseAction(), requireAdmin(), EXERCISE_IMAGE_ALLOWED_EXTENSIONS, EXERCISE_IMAGE_ALLOWED_MIME_TYPES, EXERCISE_EQUIPMENT_OPTIONS, EXERCISE_MUSCLE_GROUPS (+16 more)

### Community 30 - "RootLayout"
Cohesion: 0.09
Nodes (35): deleteSavedRoutineAction(), renameSavedRoutineAction(), setActiveSavedRoutineAction(), activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps (+27 more)
...
Cohesion: 0.08
Nodes (28): getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages(), RoutineCatalogCard(), RoutineCatalogClient(), RoutineCatalogClientProps, SortOption, DashboardRoutinesClient() (+20 more)
...
### Community 105 - "cn"
Cohesion: 0.08
Nodes (35): cn(), MetricItem(), DayMarker(), WeekDay, WeekDaysList(), WeekDaysListProps, NavigationGroup, resolveShellRouteMeta() (+27 more)
...
### Community 120 - "proxy"
Cohesion: 0.14
Nodes (20): CatalogoPage(), createRoutine(), CreateRoutineInput, deleteRoutine(), ExerciseRow, getRoutineById(), insertRoutineChildren(), listRoutineTemplates() (+12 more)
...
Cohesion: 0.09
Nodes (18): EQUIPMENT_LABELS, ExerciseAdminClientProps, ExerciseFormSheetProps, MUSCLE_BADGE_STYLES, MUSCLE_GRADIENTS, MUSCLE_LABELS, SortColumn, SortDirection (+10 more)
...
Cohesion: 0.11
Nodes (24): Home(), DashboardLayout(), DashboardPage(), DashboardPageProps, reasonCopy, DayWorkoutClient(), DayPageProps, DayRoutinePage() (+16 more)
...
Cohesion: 0.12
Nodes (22): AdminPage(), GET(), redirectToLogin(), AdminStats, getAdminStats(), getManagementSummary(), getRecentActivity(), ManagementSummary (+14 more)
...
Cohesion: 0.16
Nodes (10): DayWorkoutClientProps, DayWorkoutRow, DraftState, RowSaveIndicator(), RowSaveState, SummaryMetric(), WorkoutStatusToggle(), Button() (+2 more)
...
Cohesion: 0.16
Nodes (15): ExerciseAdminClient(), AdminExercisesPage(), AdminExerciseListItem, CreateExerciseInput, ExerciseCatalogItem, ExerciseRow, formatExerciseDate(), getExerciseById() (+7 more)
...
Cohesion: 0.11
Nodes (16): accessNotes, errorCopy, LoginPageProps, reasonCopy, statusCopy, PlaceholderPanelProps, WeekDay, WeekSchedulePreviewProps (+8 more)
...
## Knowledge Gaps
- **2432 isolated node(s):** `supabase_gymcontrol`, `ExerciseAdminClientProps`, `SortColumn`, `SortDirection`, `MUSCLE_LABELS` (+2427 more)
...
- **What is the exact relationship between `Sidebar Navigation (Finished) - GymControl Panel Operativo` and `Mis Rutinas Dashboard (To Do) - Routine Catalog with Stats`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Skills And Agents` connect `ExerciseCatalogItem` to `consumeOtpRequestRateLimit`, `Auth Transition Validation & Root Docs`, `Community 308`, `Community 310`, `ExerciseFormField`, `Community 284`?**
