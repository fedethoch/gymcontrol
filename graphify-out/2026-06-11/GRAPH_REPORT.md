# Graph Report - gymcontrol  (2026-06-11)

## Corpus Check
- 394 files · ~557,451 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3743 nodes · 4693 edges · 367 communities (331 shown, 36 thin omitted)
- Extraction: 95% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 210 edges (avg confidence: 0.84)
...
1. `cn()` - 63 edges
2. `createSupabaseServerClient()` - 42 edges
3. `PLAN.md` - 24 edges
...
## Communities (367 total, 36 thin omitted)

### Community 0 - "Project Foundations & Tech Stack"
Cohesion: 0.30
Nodes (7): AGENTS.md, docs/codex/ (Codex routing layer), PLAN.md, docs/PROJECT_FOUNDATIONS.md, docs/SKILLS_AND_AGENTS.md, docs/WORKING_AGREEMENTS.md, Definir lineamientos de instrucciones optimizadas en tokens
...
Cohesion: 0.11
Nodes (23): saveExerciseAction(), EXERCISE_IMAGE_ALLOWED_EXTENSIONS, EXERCISE_IMAGE_ALLOWED_MIME_TYPES, ExerciseFormField, ExerciseFormPayload, ExerciseFormState, INITIAL_EXERCISE_FORM_STATE, ExerciseImageValidationResult (+15 more)

### Community 30 - "RootLayout"
Cohesion: 0.14
Nodes (23): activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), ExerciseRow, formatDateLabel(), getSavedRoutineByTemplateForUser(), hasActiveSavedRoutineForUser(), mapSavedRoutineDetail(), mapSavedRoutineListItem() (+15 more)
...
Cohesion: 0.12
Nodes (23): getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages(), RoutineCatalogCard(), RoutineCatalogClient(), RoutineCatalogClientProps, SortOption, DashboardRoutinesClientProps (+15 more)

### Community 35 - "deleteSavedRoutineAction"
Cohesion: 0.06
Nodes (34): dependencies, class-variance-authority, clsx, framer-motion, lucide-react, next, @radix-ui/react-dialog, @radix-ui/react-select (+26 more)
...
Cohesion: 0.13
Nodes (24): autosaveWorkoutSessionItemAction(), parsePositiveInteger(), parsePositiveNumber(), parseWorkoutItem(), revalidateWorkoutPaths(), calculateCurrentStreak(), formatDateOnly(), getCurrentWeekRange() (+16 more)
...
Cohesion: 0.20
Nodes (11): app/lib/supabase/ (clientes Supabase), .env.example, G5 (auth, proteccion de rutas), eslint-config-next, Next.js 16, React 19, @supabase/supabase-js, @supabase/ssr (+3 more)
...
Cohesion: 0.29
Nodes (7): app/components/ui/ (primitivas), app/globals.css, app/layout.tsx, app/page.tsx, docs/ARCHITECTURE.md, Estructura app/ (admin, auth, catalogo, dashboard, components, data, lib, validations), G4.5 (refinamiento visual y vistas)

### Community 67 - "listExerciseCatalogItems"
Cohesion: 0.12
Nodes (23): INITIAL_ROUTINE_FORM_STATE, RoutineDayWriteInput, RoutineFormDayPayload, RoutineFormField, RoutineFormItemPayload, RoutineFormPayload, RoutineFormState, RoutineItemFormField (+15 more)
...
Cohesion: 0.08
Nodes (25): CatalogoPage(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient(), AdminRoutineListItem, createRoutine(), CreateRoutineInput (+17 more)
...
Cohesion: 0.20
Nodes (9): CLAUDE.md (Gymcontrol), Codex context layer maintenance, Context router, Formato de salida, Fuentes de verdad, graphify, Reglas de ahorro, Skills and subagents routing (+1 more)
...
Cohesion: 0.42
Nodes (5): docs/DATABASE.md (esquema G2), Esquema G2: 6 tablas (profiles, exercises, routine_templates, routine_days, routine_items, saved_routines), docs/MCP_SUPABASE_SETUP.md, alias supabase_gymcontrol (MCP), supabase/migrations/
...
### Community 105 - "cn"
Cohesion: 0.10
Nodes (29): cn(), NavigationGroup, resolveShellRouteMeta(), shellNavigationGroups, ShellRouteMeta, shellRouteMetas, shellUtilityLinks, isActivePath() (+21 more)
...
### Community 120 - "proxy"
Cohesion: 0.11
Nodes (20): AdminPage(), ExerciseAdminClient(), ExerciseAdminClientProps, ExerciseListThumbProps, UploadStatus, AdminExercisesPage(), AdminExerciseListItem, CreateExerciseInput (+12 more)
...
Cohesion: 0.11
Nodes (28): adminModules, RoutineDetailClientProps, accessNotes, errorCopy, LoginPageProps, reasonCopy, statusCopy, ExerciseDetail (+20 more)
...
Cohesion: 0.11
Nodes (17): DayWorkoutClient(), DayWorkoutClientProps, DayWorkoutRow, DraftState, RowSaveIndicator(), RowSaveState, SummaryMetric(), WorkoutStatusToggle() (+9 more)
...
Cohesion: 0.12
Nodes (13): DashboardRoutinesClient(), DashboardPageProps, reasonCopy, BusyState, OtpLoginFlow(), OtpLoginFlowProps, requestErrorCopy, verifyErrorCopy (+5 more)
...
Cohesion: 0.19
Nodes (16): Home(), deleteSavedRoutineAction(), renameSavedRoutineAction(), setActiveSavedRoutineAction(), DashboardLayout(), DashboardPage(), DayPageProps, DayRoutinePage() (+8 more)

### Community 361 - "Community 361"
Cohesion: 0.21
Nodes (14): AdminLayout(), GET(), redirectToLogin(), AppRole, AuthContext, getPostLoginRedirectPath(), loadAuthContext(), loadProfileRecord() (+6 more)

### Community 362 - "Community 362"
Cohesion: 0.24
Nodes (6): ExerciseDetailModalProps, Dialog(), DialogContent(), DialogDescription(), DialogHeader(), DialogTitle()

### Community 363 - "Community 363"
Cohesion: 0.22
Nodes (9): bodyFont, displayFont, metadata, monoFont, RootLayout(), getOptionalAuthContext, LoginPage(), AppShell() (+1 more)

### Community 364 - "Community 364"
Cohesion: 0.36
Nodes (6): getRequestOrigin(), activateFirstSavedRoutineForUser(), POST(), POST(), redirectToLogin(), createSupabaseServerClient()
...
## Knowledge Gaps
- **2384 isolated node(s):** `supabase_gymcontrol`, `ExerciseAdminClientProps`, `UploadStatus`, `ExerciseListThumbProps`, `adminModules` (+2379 more)
