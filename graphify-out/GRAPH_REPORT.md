...
## Corpus Check
- 694 files · ~1,672,409 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6112 nodes · 10421 edges · 486 communities (444 shown, 42 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7445b39`
...
## Communities (486 total, 42 thin omitted)
...
Cohesion: 0.12
Nodes (30): CatalogEmpty(), CatalogNoResults(), CatalogFeatureCard(), CatalogRoutineList(), LevelCarousel(), handleScroll(), updateCurrent(), WeekBar() (+22 more)

### Community 10 - "cn"
Cohesion: 0.05
Nodes (69): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, ExerciseAdminClientProps, ExerciseFormSheetProps, SortColumn, SortDirection (+61 more)
...
Cohesion: 0.11
Nodes (14): HomeGreeting(), HomeWeekStrip(), TodayExercisesSheet(), buildWeek(), DayCell, WeekCombinedCard(), WeekCombinedCardProps, countDatesThisWeek() (+6 more)
...
Cohesion: 0.13
Nodes (27): activateRoutineFromCatalogAction(), revalidateRoutineSelection(), saveRoutineFromCatalogAction(), RoutineExerciseRef, activateIfRequested(), ExerciseRow, formatDateLabel(), getSavedRoutineByTemplateForUser() (+19 more)
...
Cohesion: 0.09
Nodes (24): FoodSearchBar(), RecipeCreateDrawer(), RecipeCreateRequest, RecipeDetailDrawer(), RecipesEmpty(), RecipesHeader(), RecipesMobile(), handleCreated() (+16 more)
...
Cohesion: 0.09
Nodes (43): WeekStats(), ExerciseStage(), SetList(), SetRow, ActionButton(), FinishConfirm(), RestCard(), SetDoneButton() (+35 more)

### Community 22 - "RegistroMobile.tsx"
Cohesion: 0.09
Nodes (29): BudgetBlock(), DiaryHeader(), addLabelFor(), DEFAULT_LABELS, ItemSheetState, NO_CREATED, registroHref(), RegistroMobile() (+21 more)

### Community 23 - "foods.ts"
Cohesion: 0.11
Nodes (29): deleteFoodAction(), saveFoodAction(), SaveFoodResult, FoodAdminClient(), confirmDelete(), FoodFormSheet(), handleSubmit(), AdminFoodsPage() (+21 more)
...
Cohesion: 0.12
Nodes (30): CatalogMobileView(), changeDays(), changeLevel(), changeObjective(), clearFilters(), markInteracted(), openFilters(), openSearch() (+22 more)
...
Cohesion: 0.04
Nodes (66): ActivityMeter(), BAR_HEIGHTS, ACTIVITY_OPTIONS, ActivityOptions(), ActivitySheet(), BodyFatCarousel(), bodyFatImageSrc(), BodyFatOption (+58 more)
...
Cohesion: 0.14
Nodes (18): deleteExerciseAction(), saveExerciseAction(), ExerciseAdminClient(), confirmDelete(), AdminExercisesPage(), ExerciseFormPayload, createAnonClient(), createExercise() (+10 more)

### Community 33 - "requireUser"
Cohesion: 0.15
Nodes (17): DashboardLayout(), requireUser(), deactivateSavedRoutineForUser(), deleteSavedRoutineForUser(), renameSavedRoutineForUser(), ActionResult, activateSavedRoutineAction(), deactivateSavedRoutineAction() (+9 more)
...
Cohesion: 0.07
Nodes (39): calculateStreak(), withCurrentDay(), deleteMeal(), deleteMealItem(), MealLog, updateMeal(), addItemSchema, addMealItemAction() (+31 more)
...
Cohesion: 0.11
Nodes (14): DeleteAccountSheet(), NameSheet(), NEXT_KEYS, OptionItem, PREV_KEYS, ProfileIdentity(), SetupHero(), BodyFatFigure() (+6 more)
...
Cohesion: 0.17
Nodes (20): buildRoutineDetailView(), catalogDaysHref(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailMobile(), displayRoutineName(), averageMinutes() (+12 more)
...
Cohesion: 0.17
Nodes (18): DayClosedPanel(), DaySheet(), FrequentRows(), QuickRow, MealPanel(), RegistroSheet(), CHOICE_CHIP_CLASS, ICON_BUTTON_CLASS (+10 more)
...
Cohesion: 0.08
Nodes (50): FrequentUsage, addMealItems(), buildItemValues(), createMealWithItems(), emptyMealLog(), ensureMealLogId(), findMealLogId(), FoodRow (+42 more)
...
Cohesion: 0.10
Nodes (32): getSavedRoutineByIdForUser(), computeWeeklyStreak(), estimateDayMinutes(), estimateE1rm(), findBestSet(), parsePlanTarget(), parseRestSeconds(), resolveExerciseKind() (+24 more)
...
Cohesion: 0.11
Nodes (35): Comparison(), delta(), ExerciseHistoryData, ExerciseHistoryPanel(), ExercisePlanRow(), PlanStat, Change(), ExerciseTrend() (+27 more)
...
Cohesion: 0.09
Nodes (41): FoodDetailBody(), FoodRow(), CatalogQuery, ChipCounts, ChipOption, defaultFoodPortion(), filterFoodsByChip(), firstParam() (+33 more)

### Community 258 - "RoutineWeekView.tsx"
Cohesion: 0.09
Nodes (22): DetailDay, DetailDays(), DetailExercise, subscribeNothing(), CompactDayAction(), DayAction(), WeekDay, DayTabs() (+14 more)
...
### Community 289 - "motion.tsx"
Cohesion: 0.07
Nodes (27): DIFFICULTY_BADGE_VARIANT, quickActions, RecentExercisesTable(), OtpLoginFlowProps, getRoutineCoverImage(), getRoutineItemCount(), RoutineCatalogCard(), RoutineCatalogClientProps (+19 more)
...
Cohesion: 0.12
Nodes (27): DietView(), KCAL_PER_G, MACROS, MacroSliders(), setCustomMacro(), setMacroPreset(), adjustCustomMacros(), ADJUSTMENT_RANGE (+19 more)
...
### Community 300 - "home-dashboard.ts"
Cohesion: 0.19
Nodes (11): formatDayTitle(), HEIGHT_BY_STATE, HeroDay, TodayHero(), HeroState, MealRow, MUSCLE_GROUP_LABELS, resolveHeroState() (+3 more)

### Community 301 - "app/rutinas/page.tsx"
Cohesion: 0.12
Nodes (21): ChooseRoutineMobile(), EmptyRoutineMobile(), ROUTINE_XXL_CLASS, RoutineSwitcher(), getSessionProgress(), initialDayIndex(), findActiveSavedRoutine(), getLocalTrainingDate() (+13 more)

### Community 302 - "registro/page.tsx"
Cohesion: 0.18
Nodes (23): DayPickerSheet(), WEEKDAY_NAMES, addDaysToDateKey(), APP_TIME_ZONE, DATE_KEY_FORMATTER, getMondayFirstWeekdayIndex(), getTodayDateKey(), getWeekStartDateKey() (+15 more)
...
Cohesion: 0.08
Nodes (29): NutritionCatalogClient(), Highlight(), RecipeList(), RecipeRow(), SelectRecipe, MAX_LOG_QUANTITY, normalizeSearchText(), scoreName() (+21 more)
...
### Community 320 - "DayWorkoutClient.tsx"
Cohesion: 0.13
Nodes (20): DayExercise, Drafts, WorkoutHandlers, DayState, describeSuggestion(), DraftSet, ExerciseDraft, ExercisePlan (+12 more)
...
Cohesion: 0.07
Nodes (23): Chip, FoodChips(), FoodCreateDrawer(), FoodCreateRequest, FoodDetailDrawer(), FoodList(), FoodsEmpty(), FoodsHeader() (+15 more)
...
Cohesion: 0.10
Nodes (40): WorkoutSyncRunner(), SyncIndicator(), WorkoutTopBar(), padSets(), sanitizeNumber(), toDraftSet(), enqueueFinish(), enqueueItem() (+32 more)
...
Cohesion: 0.09
Nodes (22): 0. Estado actual en código, 10. Decisiones abiertas para el rediseño, 1. Fuentes y metodología, 2. Ratios 1RM ÷ peso corporal (StrengthLevel), 3. Tabla de trabajo: kg de 1RM por grupo, sexo y edad, 4. Edad, 5. Sexo, 6. Equivalencias entre ejercicios (+14 more)
...
### Community 395 - "nutrition-types.ts"
Cohesion: 0.08
Nodes (32): FormState, NutritionCatalogClientProps, SelectFood, MACRO_KEYS, MacroRing(), FoodForm(), handleSubmit(), FoodFormProps (+24 more)

### Community 396 - "useProfileForm.ts"
Cohesion: 0.11
Nodes (30): macroGramsSchema, manualTargetSchema, profileInputSchema, saveNutritionProfileAction(), ConfiguracionPage(), ProfileSaveStatus, calculateBmr(), calculateMacros() (+22 more)

### Community 397 - "recipe-catalog.test.mjs"
Cohesion: 0.17
Nodes (13): RecipeDetailBody(), formatPortions(), mealChoiceLabel(), recipeIngredientRows(), recipePortion, registerRecipeLabel(), registroRecipeHref(), avena (+5 more)
...
Cohesion: 0.08
Nodes (44): MACROS, View, ProfileSheet(), SheetExercise, MACROS, View, DetailTopBar(), countActiveFilters() (+36 more)

### Community 424 - "recipes.ts"
Cohesion: 0.12
Nodes (19): AdminRecetasPage(), AlimentosPage(), readFrequentItems(), getOptionalAuthContext, createAnonClient(), listFoodCatalogItems, listFoodsForUser(), listFrequentItems() (+11 more)

### Community 425 - "useProfileForm"
Cohesion: 0.16
Nodes (12): deleteAccountAction(), saveProfileNameAction(), ConfiguracionClient(), handleDeleteAccount(), handleSaveName(), inRange(), useProfileForm(), handleGenderChange() (+4 more)
...
Cohesion: 0.07
Nodes (36): AdminLayout(), deleteRoutineAction(), restoreRoutineAction(), revalidateRoutinePaths(), saveRoutineAction(), AdminRoutinesPage(), createEmptyDay(), createEmptyItem() (+28 more)
...
Cohesion: 0.06
Nodes (47): DiaryActions, serverDiaryActions, AddResult, STALE_MESSAGES, buildMealRows(), AddTarget, Budget, BudgetState (+39 more)
...
Cohesion: 0.10
Nodes (25): fadeRow, RoutineDetailClient(), RoutineDetailClientProps, Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AnimatedMacroBar() (+17 more)
...
Cohesion: 0.14
Nodes (16): AccountRows(), HomeSectionHeader(), HomeWeekStats(), CALLOUTS, MuscleAnatomy(), changeView(), MuscleStrengthPoint, Side (+8 more)
...
Cohesion: 0.12
Nodes (23): ExerciseMedia(), MediaView, ExerciseSheet(), ExerciseSheetTab, SheetBody(), ExerciseDetail, ExerciseDetailModal(), ExerciseDetailModalProps (+15 more)

### Community 462 - "catalogo/page.tsx"
Cohesion: 0.21
Nodes (12): CatalogoPage(), getVisiblePages(), RoutineCatalogClient(), handleClearFilters(), handleFilterChange(), parseDayOption(), toCatalogRoutine(), listSavedRoutineStatusesForUser() (+4 more)
...
Cohesion: 0.20
Nodes (9): ActionContext, ActionControl(), CompactDetailAction(), DetailAction(), GroupVolume, MuscleBalance(), RoutineDetailView, DetailState (+1 more)
...
### Community 485 - "deleteOwnFoodAction"
Cohesion: 0.67
...
- **What is the exact relationship between `Next.js Logo` and `Vercel Triangle Logo`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `cn()` connect `cn` to `food-catalog.ts`, `RoutineWeekView.tsx`, `DayCountWheel.tsx`, `server.ts`, `routine-catalog.ts`, `nutrition-types.ts`, `app/page.tsx`, `recipe-catalog.test.mjs`, `RecipesMobile.tsx`, `WorkoutMobile.tsx`, `routine-catalog.test.mjs`, `GoalSheet.tsx`, `auth-otp.ts`, `motion.tsx`, `FoodSearchBar.tsx`, `ProjectionSection.tsx`, `utils.ts`, `useProfileForm`, `meal-amounts.ts`, `home-dashboard.ts`, `registro/actions.ts`, `registro/page.tsx`, `app/rutinas/page.tsx`, `ConfiguracionClient.tsx`, `recipe-catalog.ts`, `CompactDayBar.tsx`, `NumberStepper.tsx`, `MealMenuSheet`, `RegistroClient.tsx`, `DayWorkoutClient.tsx`, `MuscleAnatomy.tsx`, `exercise-history.ts`, `workout-sync-queue.ts`, `SetFocus.tsx`, `RoutineDetailMobile.tsx`, `MealPanel.tsx`, `PrimaryNavigation.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `createSupabaseServerClient()` connect `createSupabaseServerClient` to `server.ts`, `useProfileForm.ts`, `saved-routines.ts`, `foods.ts`, `auth-otp.ts`, `exercises.ts`, `requireUser`, `recipes.ts`, `useProfileForm`, `meal-logs.ts`, `routines.ts`, `registro/actions.ts`, `registro/page.tsx`, `recetas/actions.ts`, `app/rutinas/page.tsx`, `auth.ts`, `workout-tracking.ts`, `workout-sync.ts`, `catalogo/page.tsx`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `CatalogMobileView()` connect `routine-catalog.test.mjs` to `routine-catalog.ts`, `cn`, `catalogo/page.tsx`?**
