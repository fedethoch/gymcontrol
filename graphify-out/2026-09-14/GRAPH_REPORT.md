# Graph Report - gymcontrol  (2026-09-14)

## Corpus Check
- 502 files · ~3,832,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4740 nodes · 6347 edges · 431 communities (389 shown, 42 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 105 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe88d8f0`
...
1. `cn()` - 118 edges
2. `createSupabaseServerClient()` - 81 edges
3. `DATABASE.md - data model source of truth` - 37 edges
4. `requireUser()` - 33 edges
5. `PLAN.md` - 24 edges
6. `Button()` - 23 edges
7. `Home()` - 22 edges
8. `Frontend Experience` - 22 edges
9. `Plan - indice y orden de ejecucion` - 18 edges
10. `graphify Skill (/graphify)` - 17 edges
...
- `Grupo G13 - Transicion de auth dual` --implements--> `Auth Dual: OTP Email + Google OAuth`  [INFERRED]
  PLAN.md → README.md
- `GymControl (README)` --references--> `PLAN.md (MVP Execution Plan)`  [EXTRACTED]
  README.md → PLAN.md
- `handleSubmit()` --calls--> `saveExerciseAction()`  [EXTRACTED]
  app/admin/ejercicios/ExerciseAdminClient.tsx → app/admin/ejercicios/actions.ts
...
### Community 5 - "cn"
Cohesion: 0.09
Nodes (28): HomeGreeting(), SheetExercise, TodayExercisesSheet(), Drawer(), DrawerContent(), DrawerDescription(), DrawerFooter(), DrawerHeader() (+20 more)
...
Cohesion: 0.08
Nodes (31): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, RecipeAdminClientProps, RecipeFormSheetProps, NutritionCatalogClientProps, MacroBar() (+23 more)
...
Cohesion: 0.19
Nodes (13): AdminRecetasPage(), RecipeIngredient, AdminRecipeListItem, formatDateLabel(), getRecipeById(), listAdminRecipes(), listRecipeCatalogItems(), mapRecipe() (+5 more)
...
Cohesion: 0.09
Nodes (33): activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), RoutineDay, RoutineExerciseRef, activateFirstSavedRoutineForUser(), deleteSavedRoutineForUser(), ExerciseRow, formatDateLabel() (+25 more)
...
Cohesion: 0.09
Nodes (34): DIFFICULTY_BADGE_VARIANT, quickActions, RecentExercisesTable(), dayLabel(), formatDateLabel(), formatDateOnly(), NutritionCalendarCard(), WEEK_LABELS (+26 more)
...
Cohesion: 0.11
Nodes (29): saveRoutineAction(), AdminRoutinesPage(), CatalogoPage(), listExerciseCatalogItems, AdminRoutineListItem, createAnonClient(), createRoutine(), CreateRoutineInput (+21 more)

### Community 22 - "createSupabaseServerClient"
Cohesion: 0.09
Nodes (48): deleteAccountAction(), handleDeleteAccount(), ConfiguracionPage(), requireUser(), addDays(), addMealLogItem(), createMeal(), deleteMeal() (+40 more)

### Community 23 - "alimentos/actions.ts"
Cohesion: 0.18
Nodes (15): saveFoodAction(), SaveFoodResult, FoodFormSheet(), handleSubmit(), createFood(), FoodFormField, FoodFormPayload, FoodFormState (+7 more)
...
Cohesion: 0.09
Nodes (28): DIFFICULTY_BADGE_STYLES, OBJECTIVE_BADGE_STYLES, OBJECTIVE_DOT_STYLES, RoutineAdminClientProps, RoutineFormSheetProps, SortColumn, SortDirection, getRoutineCoverImage() (+20 more)
...
Cohesion: 0.09
Nodes (27): deleteRoutineAction(), RoutineAdminClient(), confirmDelete(), INITIAL_ROUTINE_FORM_STATE, RoutineDayWriteInput, RoutineFormDayPayload, RoutineFormField, RoutineFormItemPayload (+19 more)
...
### Community 30 - "DayWorkoutClient.tsx"
Cohesion: 0.11
Nodes (22): countCompletedSeries(), DayWorkoutClient(), handleDraftChange(), handleToggleCompleted(), isAllCompleted(), scheduleAutosave(), startRestTimer(), DayWorkoutClientProps (+14 more)
...
### Community 32 - "ExerciseAdminClient.tsx"
Cohesion: 0.07
Nodes (36): ExerciseAdminClientProps, ExerciseFormSheetProps, SortColumn, SortDirection, UploadStatus, ExerciseDetail, ExerciseDetailModal(), ExerciseDetailModalProps (+28 more)

### Community 33 - "home-dashboard.ts"
Cohesion: 0.15
Nodes (14): formatDayTitle(), HEIGHT_BY_STATE, HeroDay, TodayHero(), buildMealRows(), HeroState, HOME_MEAL_TYPES, MealRow (+6 more)
...
Cohesion: 0.10
Nodes (35): HomeNutrition(), BODY_FAT_VALUES, BodyFatFigure(), AnimatedMacroBar(), AnimatedNumber(), fadeScale, listItemHover, microTransition (+27 more)
...
### Community 62 - "BodyMuscleFigure.tsx"
Cohesion: 0.16
...
Cohesion: 0.13
Nodes (19): deleteExerciseAction(), saveExerciseAction(), ExerciseAdminClient(), confirmDelete(), AdminExercisesPage(), AdminLayout(), requireAdmin(), createAnonClient() (+11 more)
...
Cohesion: 0.12
Nodes (16): getSessionProgress(), resolveHeroState(), MOCK_FOODS, MOCK_FOODS_BASE, MOCK_PROFILE_DEFAULTS, listSavedRoutinesForUser(), MuscleStrengthSummary, ComidasHoyCard() (+8 more)
...
### Community 169 - "OtpLoginFlow.tsx"
Cohesion: 0.18
Nodes (10): BusyState, OtpLoginFlowProps, requestErrorCopy, verifyErrorCopy, InputOtp(), InputOtpProps, Slot(), LoadingDots() (+2 more)

### Community 170 - "RegistroClient.tsx"
Cohesion: 0.09
Nodes (20): fadeRow, RoutineDetailClientProps, Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), MEAL_TYPE_IMAGES, calculateStreak() (+12 more)
...
Cohesion: 0.10
Nodes (36): getSavedRoutineByIdForUser(), addDays(), calculateCurrentStreak(), ExerciseHistoryEntry, formatDateOnly(), formatHistoryDate(), getCompletedTrainingDates(), getCurrentWeekRange() (+28 more)
...
### Community 258 - "MuscleAnatomy.tsx"
Cohesion: 0.15
...
### Community 293 - "RoutineFormSheet"
Cohesion: 0.24
Nodes (6): createEmptyDay(), createEmptyItem(), RoutineFormSheet(), handleAddDay(), handleAddItem(), handleSubmit()

### Community 294 - "WeekCombinedCard.tsx"
Cohesion: 0.19
Nodes (11): HomeWeekStrip(), buildWeek(), DayCell, WeekCombinedCard(), WeekCombinedCardProps, countDatesThisWeek(), formatDateOnly(), getCurrentWeekDays() (+3 more)
...
### Community 344 - "foods.ts"
Cohesion: 0.22
Nodes (12): AdminFoodsPage(), NutritionCatalogClient(), NutricionPage(), AdminFoodListItem, createAnonClient(), FoodInput, FoodRow, formatDateLabel() (+4 more)

### Community 345 - "TrainingCalendarCard.tsx"
Cohesion: 0.48
Nodes (6): dayLabel(), formatDateLabel(), formatDateOnly(), TrainingCalendarCard(), TrainingCalendarCardProps, WEEK_LABELS

### Community 346 - "dia/actions.ts"
Cohesion: 0.48
Nodes (6): saveWorkoutSessionForWeek(), WorkoutSessionItemInput, autosaveWorkoutSessionItemAction(), parseSeriesValues(), parseWorkoutItem(), revalidateWorkoutPaths()
...
### Community 351 - "recetas/actions.ts"
Cohesion: 0.23
Nodes (11): deleteRecipeAction(), SaveRecipeResult, deleteRecipe(), INITIAL_RECIPE_FORM_STATE, ParsedRecipePayload, RecipeFormField, RecipeFormPayload, RecipeFormState (+3 more)
...
### Community 359 - "Integrar acceso admin en el shell general: unificar la entrada administrativa sin duplicar la experiencia base"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (37): isStandaloneDisplay(), PwaRuntime(), MobileHeader(), MobileHeaderBadge, MobileHeaderContext, MobileHeaderProps, MobileHeaderState, MobileHeaderStateProvider() (+29 more)
...
### Community 380 - "server.ts"
Cohesion: 0.15
Nodes (14): ExerciseFormSheet(), clearObjectUrl(), handleFileChange(), handleSubmit(), POST(), validateExerciseImageFile(), createSupabaseAdminClient(), createSupabaseBrowserClient() (+6 more)
...
Cohesion: 0.07
Nodes (28): 0. Principios, 10.1 Zonas (arriba → abajo), 10.2 Estados del hero, 10.3 Tus músculos sin datos, 10. Home mobile (`/`, <1024px), 1.1 Superficies (se mantienen), 1.2 Texto, 1.3 Acento — Emerald (NUEVO, reemplaza violeta) (+20 more)
...
### Community 423 - "[id]/page.tsx"
Cohesion: 0.13
Nodes (15): errorCopy, LoginPage(), LoginPageProps, statusCopy, CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps, StatPillProps, RoutineDetailClient() (+7 more)

### Community 424 - "saveRecipeAction"
Cohesion: 0.28
Nodes (6): saveRecipeAction(), RecipeFormSheet(), handleSubmit(), createRecipe(), replaceRecipeItems(), updateRecipe()

### Community 426 - "Implementar autenticacion base de usuario: habilitar Supabase Auth server-side para el MVP"
Cohesion: 0.22
...
### Community 428 - "02-integrar-type-rol-al-flujo-de-acceso-y-sesion.md"
Cohesion: 0.33
...
### Community 429 - "deleteFoodAction"
Cohesion: 0.33
Nodes (4): deleteFoodAction(), FoodAdminClient(), confirmDelete(), deleteFood()

### Community 430 - "start/route.ts"
Cohesion: 0.70
...
## Knowledge Gaps
- **2851 isolated node(s):** `supabase_gymcontrol`, `RecentActivityEntry`, `ACTIVITY_ICONS`, `FoodAdminClientProps`, `SortColumn` (+2846 more)
...
- **What is the exact relationship between `Next.js Logo` and `Vercel Triangle Logo`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `createSupabaseServerClient()` connect `createSupabaseServerClient` to `recipes.ts`, `saved-routines.ts`, `routines.ts`, `alimentos/actions.ts`, `routine-validation.ts`, `request-otp/route.ts`, `ConfiguracionClient.tsx`, `[id]/page.tsx`, `saveRecipeAction`, `deleteFoodAction`, `start/route.ts`, `admin-stats.ts`, `exercises.ts`, `workout-tracking.ts`, `app/page.tsx`, `foods.ts`, `recetas/actions.ts`, `auth.ts`, `server.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `ExerciseAdminClient.tsx`, `home-dashboard.ts`, `MuscleAnatomy.tsx`, `ConfiguracionClient.tsx`, `WeekCombinedCard.tsx`, `OtpLoginFlow.tsx`, `FoodAdminClient.tsx`, `RegistroClient.tsx`, `PrimaryNavigation.tsx`, `admin/page.tsx`, `RoutineAdminClient.tsx`, `server.ts`, `DayWorkoutClient.tsx`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `requireAdmin()` connect `exercises.ts` to `saveRecipeAction`, `auth.ts`, `deleteFoodAction`, `routines.ts`, `createSupabaseServerClient`, `alimentos/actions.ts`, `routine-validation.ts`, `recetas/actions.ts`?**
