# Graph Report - gymcontrol  (2026-06-14)

## Corpus Check
- 455 files · ~741,448 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4290 nodes · 5847 edges · 387 communities (351 shown, 36 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 214 edges (avg confidence: 0.84)
...
1. `createSupabaseServerClient()` - 82 edges
2. `cn()` - 80 edges
...
10. `GymControl Agents Guide` - 19 edges
...
## Communities (387 total, 36 thin omitted)
...
Cohesion: 0.14
Nodes (11): FoodMeasure, calculateStreak(), DraftItem, formatDateOnly(), MealCard(), RegistroClient(), TargetBar(), formatDateLabel() (+3 more)

### Community 30 - "RootLayout"
Cohesion: 0.09
Nodes (37): deleteSavedRoutineAction(), renameSavedRoutineAction(), toggleActiveSavedRoutineAction(), DashboardLayout(), activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), CatalogRoutineDetailPage(), CatalogRoutineDetailPageProps (+29 more)
...
Cohesion: 0.13
Nodes (16): getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages(), RoutineCatalogCard(), RoutineCatalogClient(), RoutineCatalogClientProps, SortOption, Button() (+8 more)
...
Cohesion: 0.09
Nodes (39): Home(), autosaveWorkoutSessionItemAction(), parseSeriesValues(), parseWorkoutItem(), revalidateWorkoutPaths(), DayPageProps, DayRoutinePage(), ROUTINE_DIFFICULTY_LABELS (+31 more)
...
Cohesion: 0.09
Nodes (33): INITIAL_ROUTINE_FORM_STATE, RoutineDayWriteInput, RoutineFormDayPayload, RoutineFormField, RoutineFormItemPayload, RoutineFormPayload, RoutineFormState, RoutineItemFormField (+25 more)
...
Cohesion: 0.13
Nodes (20): NavigationGroup, resolveShellRouteMeta(), shellNavigationGroups, ShellRouteMeta, shellRouteMetas, shellSecondaryLinks, shellUtilityLinks, isActivePath() (+12 more)
...
### Community 105 - "cn"
Cohesion: 0.24
Nodes (8): DashboardRoutinesClient(), DashboardPage(), DashboardPageProps, reasonCopy, ROUTINE_OBJECTIVE_LABELS, listSavedRoutinesForUser(), StatusToast(), StatusToastProps
...
Cohesion: 0.09
Nodes (32): ACTIVITY_ICONS, DIFFICULTY_BADGE_VARIANT, formatActivityDate(), quickActions, startOfDay(), RecentExercisesTable(), ExerciseAdminClientProps, ExerciseFormSheet() (+24 more)
...
Cohesion: 0.09
Nodes (23): ToggleOption(), calculateBmr(), calculateMacros(), calculateNutritionPlan(), MOCK_FOODS, MOCK_FOODS_BASE, MOCK_PROFILE_DEFAULTS, ACTIVITY_LEVEL_INFO (+15 more)
...
Cohesion: 0.14
Nodes (19): bodyFont, displayFont, metadata, monoFont, RootLayout(), GET(), redirectToLogin(), AppRole (+11 more)

### Community 215 - "Community 215"
Cohesion: 0.08
Nodes (31): errorCopy, LoginPageProps, reasonCopy, statusCopy, createEmptyDay(), createEmptyItem(), DIFFICULTY_BADGE_STYLES, OBJECTIVE_BADGE_STYLES (+23 more)

### Community 216 - "Community 216"
Cohesion: 0.31
Nodes (7): ConfiguracionClient(), ConfiguracionPage(), getNutritionProfile(), mapNutritionProfile(), NutritionProfile, NutritionProfileRow, NutritionProfileInput
...
Cohesion: 0.12
Nodes (20): AdminLayout(), deleteAccountAction(), saveNutritionProfileAction(), saveProfileNameAction(), deleteExerciseAction(), saveExerciseAction(), requireAdmin(), ExerciseFormState (+12 more)
...
Cohesion: 0.09
Nodes (35): FoodAdminClientProps, FoodFormSheetProps, SortColumn, SortDirection, NutritionCatalogClientProps, CATEGORY_ACCENT, CATEGORY_GRADIENTS, CATEGORY_ICONS (+27 more)
...
Cohesion: 0.05
Nodes (52): deleteFoodAction(), saveFoodAction(), SaveFoodResult, FoodAdminClient(), NutritionCatalogClient(), AdminFoodsPage(), NutricionPage(), AdminFoodListItem (+44 more)
...
Cohesion: 0.08
Nodes (29): CatalogoPage(), ExerciseAdminClient(), AdminExercisesPage(), CreateExerciseInput, ExerciseCatalogItem, ExerciseRow, formatExerciseDate(), getExerciseById() (+21 more)
...
Cohesion: 0.11
Nodes (32): addDays(), addMealLogItem(), createMeal(), deleteMeal(), deleteMealLogItem(), ensureMealLogId(), FoodRow, formatDateOnly() (+24 more)
...
Cohesion: 0.08
Nodes (27): DashboardRoutinesClientProps, DayWorkoutClient(), DayWorkoutClientProps, DayWorkoutRow, DraftState, RowSaveIndicator(), RowSaveState, SeriesInputsGroup() (+19 more)
...
## Knowledge Gaps
- **2664 isolated node(s):** `supabase_gymcontrol`, `FoodAdminClientProps`, `SortColumn`, `SortDirection`, `FoodFormSheetProps` (+2659 more)
