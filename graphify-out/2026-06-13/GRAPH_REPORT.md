# Graph Report - gymcontrol  (2026-06-13)

## Corpus Check
- 408 files · ~633,532 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3962 nodes · 5050 edges · 373 communities (337 shown, 36 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 210 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ec81479`
...
1. `cn()` - 71 edges
2. `createSupabaseServerClient()` - 51 edges
3. `PLAN.md` - 24 edges
4. `requireUser()` - 22 edges
5. `Frontend Experience` - 22 edges
6. `Prompt Templates` - 22 edges
7. `Next.js Best Practices` - 20 edges
8. `GymControl Agents Guide` - 19 edges
9. `Database` - 19 edges
10. `Button()` - 18 edges
...
## Communities (373 total, 36 thin omitted)
...
Cohesion: 0.13
Nodes (16): Preload Pattern (cache + preload), Directives, Next.js Directive, React Directives, `'use cache'`, `'use client'`, `'use server'`, Next.js Functions Reference (+8 more)

### Community 7 - "RLS Policies & Auth Implementation"
Cohesion: 0.26
Nodes (5): supabase/migrations/20260608_g55_mvp_rls_policies.sql, private.can_update_own_profile(...) helper, private.current_profile_id() helper, private.is_current_user_admin() helper, profiles.type_rol (fuente de verdad de autorizacion)
...
Cohesion: 0.08
Nodes (24): Modal de ejercicio, Pantalla Detalle diario de rutina, Pantalla `Ejercicio`, Relacion entre tabla y modal, Tabla de rutina, Tabla de rutina y modal de ejercicio, Archivos, Criterios de aceptacion (+16 more)
...
Cohesion: 0.05
Nodes (43): 1. Usuario auth, 2. Perfil de usuario, 3. Ejercicio, 4. Rutina plantilla, 5. Dia de rutina, 6. Fila o item de rutina, 7. Rutina guardada por usuario, Acuerdo de minima manipulacion (+35 more)
...
Cohesion: 0.08
Nodes (40): RootLayout(), deleteSavedRoutineAction(), renameSavedRoutineAction(), toggleActiveSavedRoutineAction(), DashboardLayout(), activateRoutineFromCatalogAction(), saveRoutineFromCatalogAction(), CatalogRoutineDetailPage() (+32 more)
...
Cohesion: 0.10
Nodes (22): getRoutineCoverImage(), getRoutineItemCount(), getVisiblePages(), RoutineCatalogCard(), RoutineCatalogClient(), RoutineCatalogClientProps, SortOption, DashboardRoutinesClient() (+14 more)

### Community 35 - "deleteSavedRoutineAction"
Cohesion: 0.05
Nodes (36): dependencies, class-variance-authority, clsx, framer-motion, lucide-react, next, @radix-ui/react-dialog, @radix-ui/react-dropdown-menu (+28 more)
...
Cohesion: 0.09
Nodes (23): Avoid these, Best practices, Code quality, Console & errors, Content Security Policy (CSP), Deprecated APIs, Error boundaries (React), Event listener passive (+15 more)
...
Cohesion: 0.11
Nodes (18): 1. Missing `default.tsx` → 404 on Refresh, 2. Modal Persists After Navigation, 3. Nested Parallel Routes Need Defaults Too, 4. Intercepted Route Shows Wrong Content, 5. TypeScript Errors with `params`, Common Gotchas, Complete Example: Photo Gallery Modal, default.tsx Requirement for Parallel Slots (+10 more)
...
Cohesion: 0.11
Nodes (17): Avoiding Data Waterfalls, Client Component Data Fetching, Data Patterns, Decision Tree, Option 1: Pass from Server Component (Preferred), Option 2: Fetch on Mount (When Necessary), Option 3: Server Action for Reads (Works But Not Ideal), Pattern 1: Server Components (Preferred for Reads) (+9 more)
...
Cohesion: 0.16
Nodes (14): Decision actual, Fuente de verdad, Lo que hoy no justifica una skill propia del repo, Objetivo, Regla para auth y seguridad, Skills And Agents, Skills disponibles pero no elegidas por defecto, Subagents (+6 more)
...
Cohesion: 0.17
Nodes (10): Archivos, Confirmar bootstrap admin y criterio de QA manual: cerrar la operativa minima para validar permisos, Criterios de aceptacion, Estado, Estado final, Objetivo, Pasos, Resolucion (+2 more)

### Community 76 - "RoutineFormPayload"
Cohesion: 0.26
Nodes (4): app/admin layout server-side guard (type_rol=admin), app/dashboard layout server-side guard (auth required, no admin), Estrategia de redirecciones por estado y rol, requireUser / requireAdmin server guards
...
Cohesion: 0.18
Nodes (10): CLAUDE.md (Gymcontrol), Codex context layer maintenance, Context router, Formato de salida, Frontend, Fuentes de verdad, graphify, Reglas de ahorro (+2 more)

### Community 86 - "createRoutine"
Cohesion: 0.20
Nodes (8): Commands, Hard limits, Rule of thumb, SKILL_ROUTING, Skills, Subagents, Skill/subagent validation, Test Matrix
...
### Community 105 - "cn"
Cohesion: 0.08
Nodes (37): bodyFont, displayFont, metadata, monoFont, cn(), DayMarker(), WeekDay, WeekDaysList() (+29 more)
...
Cohesion: 0.10
Nodes (21): ExerciseAdminClientProps, ExerciseFormSheet(), ExerciseFormSheetProps, SortColumn, SortDirection, UploadStatus, equipmentLabel(), MUSCLE_BADGE_STYLES (+13 more)
...
Cohesion: 0.11
Nodes (23): listExerciseCatalogItems(), AdminRoutineListItem, createRoutine(), CreateRoutineInput, ExerciseRow, getRoutineById(), insertRoutineChildren(), listAdminRoutines() (+15 more)
...
Cohesion: 0.08
Nodes (27): DashboardPage(), DashboardPageProps, reasonCopy, ROUTINE_DIFFICULTY_LABELS, listSavedRoutinesForUser(), DashboardRoutinesPage(), MetricItem(), PlaceholderPanelProps (+19 more)
...
Cohesion: 0.28
Nodes (8): AdminPage(), AdminStats, getAdminStats(), getManagementSummary(), getRecentActivity(), ManagementSummary, RecentActivityEntry, RecentActivityKind

### Community 215 - "Community 215"
Cohesion: 0.17
Nodes (18): ACTIVITY_ICONS, DIFFICULTY_BADGE_VARIANT, formatActivityDate(), quickActions, startOfDay(), fadeRow, RoutineDetailClientProps, ExerciseDetail (+10 more)

### Community 216 - "Community 216"
Cohesion: 0.12
Nodes (14): CatalogoPage(), DayWorkoutClientProps, DayWorkoutRow, DraftState, RowSaveIndicator(), RowSaveState, SeriesInputsGroup(), splitSeriesValues() (+6 more)
...
Cohesion: 0.16
Nodes (18): AdminLayout(), deleteExerciseAction(), saveExerciseAction(), ExerciseAdminClient(), AdminExercisesPage(), requireAdmin(), AdminExerciseListItem, createExercise() (+10 more)
...
Cohesion: 0.16
Nodes (11): getRequestOrigin(), config, proxy(), POST(), POST(), redirectToLogin(), createSupabaseBrowserClient(), getSupabasePublicEnv() (+3 more)
...
Cohesion: 0.33
Nodes (5): Dependencias operativas, G10 - Exercise Modal, Objetivo del grupo, Orden recomendado, Resultado esperado
...
Cohesion: 0.40
Nodes (4): G11 - Integration And QA, Objetivo del grupo, Orden recomendado, Resultado esperado
...
Cohesion: 0.83
Nodes (4): handle_new_user() trigger, profiles table, Flujo de acceso vigente (OTP + Google OAuth), Modulo: Acceso y sesion (auth)

### Community 309 - "Community 309"
Cohesion: 0.50
Nodes (3): Architecture, Nota, Orden recomendado de lectura
...
Cohesion: 0.22
Nodes (9): Archivos, Criterios de aceptacion, Documentar bootstrap admin verificable: asegurar una cuenta admin util para QA del MVP, Estado, Estado final, Objetivo, Pasos, Resolucion (+1 more)
...
Cohesion: 0.25
Nodes (8): HTTPS everywhere, Input sanitization, No vulnerable libraries, Secure cookies, Security, Security headers, Subresource Integrity (SRI) for third-party scripts, Trusted Types (modern DOM-XSS defense)
...
Cohesion: 0.12
Nodes (17): BusyState, OtpLoginFlow(), OtpLoginFlowProps, requestErrorCopy, verifyErrorCopy, errorCopy, LoginPageProps, reasonCopy (+9 more)

### Community 367 - "Community 367"
Cohesion: 0.12
Nodes (16): ROUTINE_DIFFICULTIES, ROUTINE_OBJECTIVE_LABELS, ROUTINE_OBJECTIVES, RoutineDifficulty, RoutineObjective, createEmptyDay(), createEmptyItem(), DIFFICULTY_BADGE_STYLES (+8 more)
...
## Knowledge Gaps
- **2522 isolated node(s):** `supabase_gymcontrol`, `ExerciseAdminClientProps`, `SortColumn`, `SortDirection`, `ExerciseFormSheetProps` (+2517 more)
